...
if($tipo_informe == 11){ 
  ...
  if($periodo_entrega != ''){
    ...
    ////BUSCAMOS LOS CENTROS DE ACOPIO
    $instruccion0 ="SELECT DISTINCT calculo_redondeado_escuela.cod_centro_acopio AS cod_centro_acopio, centro_acopio.nombre AS nom_centro_acopio, municipio.cod_municipio As cod_municipio, municipio.nombre As nom_municipio
                    FROM calculo_redondeado_escuela 
                    INNER JOIN centro_acopio ON centro_acopio.cod_centro_acopio = calculo_redondeado_escuela.cod_centro_acopio
                    INNER JOIN municipio ON municipio.cod_municipio = calculo_redondeado_escuela.cod_municipio
                    WHERE (calculo_redondeado_escuela.cod_programacion = $cod_programacion OR calculo_redondeado_escuela.cod_programacion = $cod_programacion2
  ...
  /// en programaciones 363 y 364 retorna ca asomapri, asomapri agrupado y asotrainfa
  ...
  $hojaExcel.="<tr>";    
  foreach ($rows0 as $i => $row_mpio) {
      $nom_municipio = $row_mpio['nom_municipio'];
      if ($i == 0) {
          $hojaExcel.="<td align='center' colspan='2'>MUNICIPIOS</td>"; 
      }
      $hojaExcel.="<td align='center'>$nom_municipio</td>";
  }
  $hojaExcel.="</tr>";
  ...
  //   echo ($nfilas0);
  //   for ($i=0; $i<$nfilas0; $i++){
  //     $row_mpio = mysql_fetch_array($consulta0);
  //     $cod_centro_acopio = $row_mpio['cod_centro_acopio'];
  //     $nom_centro_acopio = $row_mpio['nom_centro_acopio'];
  //     $cod_municipio = $row_mpio['cod_municipio'];
  //     $nom_municipio = $row_mpio['nom_municipio'];   
  ...
  //  $hojaExcel.="</tr>";
    ...
    // $consulta_m = mysql_query($instruccion_m);
    // error_consulta($consulta_m,$instruccion_m);
  //   $nfilas_m = mysql_num_rows ($consulta0);     
  //   // echo $nfilas_m;
  //   for ($m=0; $m<$nfilas0; $m++){ 
           
  //     $row_m = mysql_fetch_array($consulta0);
      
      
  //     $nom_municipio = $row_m['nom_municipio'];
  //     // echo $nom_municipio;
        
  //     $cad_municipio = $nom_municipio;  
  //     }
  ...
  $hojaExcel.="<tr>";    
    ...
    for ($j=0; $j<$nfilas1; $j++){
      ...
      ////BUSCAMOS LAS CANTIDADES PARA EL PRODUCTO POR CADA CENTRO DE ACOPIO 
      ////BUSCAMOS NUEVAMENTE LOS CENTROS DE ACOPIO  
      $instruccion2 ="SELECT DISTINCT calculo_redondeado_escuela.cod_municipio AS cod_municipio, municipio.nombre AS nom_municipio, calculo_redondeado_escuela.cod_centro_acopio AS cod_centro_acopio
                      FROM calculo_redondeado_escuela 
                      INNER JOIN municipio ON municipio.cod_municipio = calculo_redondeado_escuela.cod_municipio
                      INNER JOIN centro_acopio ON centro_acopio.cod_centro_acopio = calculo_redondeado_escuela.cod_centro_acopio
                      WHERE (calculo_redondeado_escuela.cod_programacion = $cod_programacion OR calculo_redondeado_escuela.cod_programacion = $cod_programacion2
        ...
        $cod_centro_acopio = $row2['cod_centro_acopio'];
          ...
          $instruccion_q ="SELECT SUM(calculo_redondeado_escuela.cantidad_redondeada) AS cantidad
                           ...
                           WHERE (calculo_redondeado_escuela.cod_programacion = $cod_programacion OR calculo_redondeado_escuela.cod_programacion = $cod_programacion2
                             ...
                             AND calculo_redondeado_escuela.cod_ingrediente = $cod_ingrediente AND calculo_redondeado_escuela.cod_unidad_medida = $cod_unidad_medida
                             AND calculo_redondeado_escuela.cod_centro_acopio = $cod_centro_acopio
                             AND calculo_redondeado_escuela.cod_municipio = $cod_municipio $condicion2";
