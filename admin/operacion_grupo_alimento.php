...
if($tipo_operacion == 2){
   ...
   $instruccion3 = "SELECT cod_grupo_alimento, nombre FROM grupo_alimento WHERE cod_grupo_alimento = $codigo";
...
<body>
<form action="vr_grupo_alimento.php" method="post">
