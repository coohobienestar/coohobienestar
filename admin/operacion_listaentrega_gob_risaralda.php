...
<title>LISTA DE ENTREGA GOBERNACION DE RISARALDA</title>
</head>
<body>
<?php     
...
$hojaExcel.="<table width='98%'>";
      ...
      for ($i=0; $i<$nfilas6; $i++){
        ...
        $hojaExcel.="<tr>";
        $hojaExcel.="<td width='20%'><strong>No. CUPOS ADJUDICADOS:</strong> $cupos</td>";
        if($i==0){
          $hojaExcel.="<td width='80%' rowspan='$nfilas6'><strong>SEMANAS DE CICLO DE MENU ENTREGADAS:</strong> <br> $cad_fecha - $nom_ciclo &nbsp;&nbsp; $cad_menu</td>";       
          } 
        $hojaExcel.="</tr>";
       }     
   $hojaExcel.="</table>";    
   $hojaExcel.="<table width='98%'>";
   $hojaExcel.="<tr>";
   $hojaExcel.="<td width='49%'><strong>OPERADOR: </strong>$nom_operador</td>";
   $hojaExcel.="<td width='49%'><strong>FECHA: </strong></td>";
   $hojaExcel.="</tr>";
   $hojaExcel.="</table>";
   $hojaExcel.="<table width='98%'>";  
   $hojaExcel.="<tr>";
   $hojaExcel.="<td width='49%'><strong>DEPARTAMENTO: </strong> $nom_departamento</td>";
   $hojaExcel.="<td width='49%'><strong>MUNICIPIO O VEREDA: </strong> $nom_municipio</td>";      
   $hojaExcel.="</tr>";     
   $hojaExcel.="</table>";     
   
////************************ TIPOS DE MINUTAS DE ALMUERZOS Y REFRIGERIOS  
if ($cod_tipo_minuta == 38  || $cod_tipo_minuta == 39){
...
if ($cod_tipo_minuta == 40  || $cod_tipo_minuta == 41){
...
echo $hojaExcel; 
    ...
    $sfile="../excel/FormatoListaEntregaGob_Risa"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
    $fp=fopen($sfile,"w"); 
    fwrite($fp,$hojaExcel); 
    fclose($fp);
