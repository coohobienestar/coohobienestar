...
$cod_ingrediente_intercambio = $_REQUEST['cod_ingrediente'];

if($tipo_operacion == 1){
  $error="";
  if(empty($_REQUEST['cod_ingrediente'])){
    $error=$error . "El campo no puede estar vacio.<br>";   
    echo($cod_ingrediente_intercambio);
...
$departamento = $_REQUEST[departamento];   
  ...
  if($tipo_operacion == 1){
     mysql_query("INSERT INTO intercambios (cod_programacion, cod_ingrediente_programado, cod_ingrediente_intercambio)
                                 VALUES ('$cod_programacion','$cod_ingrediente','$cod_ingrediente_intercambio')", $conexion);
    }  
