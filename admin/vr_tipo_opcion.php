...
if($tipo_operacion <= 2){
  ...
  if (empty($_REQUEST['nombre']))
    $error=$error . "El Nombre del Tipo de Opción no puede estar vacio.<br>";   
...
$nombre    = strtoupper($_REQUEST[nombre]);
  ...
  if($tipo_operacion == 1){
     mysql_query("INSERT INTO tipo_opcion (nombre) VALUES ('$nombre')", $conexion);
    }  

  if($tipo_operacion == 2){
     $instruccion4 = "UPDATE tipo_opcion SET nombre='$nombre' WHERE cod_tipo_opcion = '$codigo'";
