...
if($tipo_operacion == 1){
    $icono = "guardar.png";
   $nom_form = "REGISTRAR MARCA PRODUCTO";
 }

# EDITAR
if($tipo_operacion == 4){
   $nom_operacion = "EDITAR MARCA";
   $icono = "editar.png";
...
<body>
<form action="vr_marca.php" method="post">
...
?> 
  ...
  <?php
    ...
    print ("<TD style='font-weight:bold; color: white'>Nombre Marca </TD>");
    print ("<TD><input name='nombre_marca' placeholder='Nombre la marca'></TD>"); 
  ?>
  </tr>   
<?php
 }  
...
?>
  ...
  <TR><TD  style='font-weight:bold; color: white' ><center><strong>Va a eliminar la marca registrada</strong></center></TD></TR>      
  </TR>
<?php 
 }
if($tipo_operacion == 6){    
