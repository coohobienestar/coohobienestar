...
if ($cod_tipo_minuta == 4 || $cod_tipo_minuta == 7 || $cod_tipo_minuta == 8 || $cod_tipo_minuta == 18 || $cod_tipo_minuta == 21 || $cod_tipo_minuta == 22){
  ...
  $lugar = " Instituci�n Educativa ";
  $quitar_docente = 1;
    
////DEFINIMOS EL TIPO DE MINUTA DE HOGARES COMUNITARIOS DE RISARALDA Y TOLIMA 
if ($cod_tipo_minuta == 13 || $cod_tipo_minuta == 14 || $cod_tipo_minuta == 15){
...
if ($cod_tipo_minuta == 32 || $cod_tipo_minuta == 33 || $cod_tipo_minuta == 37 || $cod_tipo_minuta == 38 || $cod_tipo_minuta == 39){
...
<title>CONTROL ENTRADA Y SALIDA DE ALIMENTOS ESPECIAL</title>
</head>
<body>
<?php
////BUSCAMOS LOS MENUS
...
if ($cod_tipo_minuta == 1  || $cod_tipo_minuta == 2   || $cod_tipo_minuta == 3  || $cod_tipo_minuta == 5  || $cod_tipo_minuta == 6 || 
    $cod_tipo_minuta == 9  || $cod_tipo_minuta == 10  || $cod_tipo_minuta == 16 || $cod_tipo_minuta == 17 || $cod_tipo_minuta == 19 || 
    $cod_tipo_minuta == 20){ 
...
if ($cod_tipo_minuta == 75){
    $logo_1 = "<img src='../imagenes/logo_icbf.png' width='97' height='90' /><img src='../imagenes/$logo' width='100' height='60' />";

  }     

 ////MINUTAS CDI Y HOGARES - VAN CON LOGO ICBF
if ($cod_tipo_minuta == 11  || $cod_tipo_minuta == 12  || $cod_tipo_minuta == 13 || $cod_tipo_minuta == 14 || $cod_tipo_minuta == 15){
    
    $logo_1 = "<img src='../imagenes/logo_icbf.png' width='97' height='90' />";  
    $logo_2 = "<img src='../imagenes/escudo.png' width='97' height='90' />";
  } 

if($cod_tipo_minuta == 32 || $cod_tipo_minuta == 33 || $cod_tipo_minuta == 37 || $cod_tipo_minuta == 38){
   $logo_1 = "<img src='../imagenes/$logo' width='134' height='60' />";
   $logo_2 = "<img src='../imagenes/escudo.png' width='97' height='90' />";
 }
  
if($cod_tipo_minuta == 0 || $cod_tipo_minuta == 39){
...
$hojaExcel.="<table width='98%'>";
  $hojaExcel.="<tr>";
    $hojaExcel.="<td width='20%' height='74' align='center'> $logo_1 </td>";
    $hojaExcel.="<th width='60%'>$nom_formato</th>";
    $hojaExcel.="<td width='20%' align='center'> $logo_2 </td>";
    $hojaExcel.="</tr>";
    $hojaExcel.="</table>";
    $hojaExcel.="<table width='98%'>";
    $hojaExcel.="<tr>";
...
$hojaExcel.="</table>";
    ////BUSCAMOS LOS MENUS
    $instruccion_t_menus ="SELECT DISTINCT calculo_requerimientos.cod_menu AS cod_menu, menu.nombre AS nom_menu 
                    FROM calculo_requerimientos 
    ...
    $consulta_t_menus = mysql_query($instruccion_t_menus);
    error_consulta($consulta_t_menus,$instruccion_t_menus);
    $nfilas_t_menus = mysql_num_rows ($consulta_t_menus);
          
$hojaExcel.="<table width='98%'>";
  $hojaExcel.="<tr>";
    for ($m=0; $m<$nfilas_t_menus; $m++){             
      $row_t_menus = mysql_fetch_array($consulta_t_menus);
      
      $cod_menu_t = $row_t_menus['cod_menu'];  
      if($m == 0){
         $hojaExcel.="<td colspan='3'>&nbsp;</td>";
        }
      
       $hojaExcel.="<th colspan='3'>MENU $cod_menu_t</th>";
     }
    $hojaExcel.="<td>&nbsp;</td>";
  $hojaExcel.="</tr>";
  ...
  $hojaExcel.="<tr>";
      ...
      for ($i=0; $i<$nfilas7; $i++){
        ...
        if($cat_anterior != $cod_cat_ingredi){
           $hojaExcel.="<tr><th colspan='25'>$nom_cat_ingredi</th></tr>";
          }
        ...
        ////BUSCAMOS LOS MENUS
        $instruccion6 ="SELECT DISTINCT calculo_requerimientos.cod_menu AS cod_menu, menu.nombre AS nom_menu 
                        FROM calculo_requerimientos 
                        INNER JOIN menu ON menu.cod_menu = calculo_requerimientos.cod_menu
                        WHERE calculo_requerimientos.cod_programacion = $cod_programacion 
                        ORDER BY calculo_requerimientos.cod_menu";
...
$hojaExcel.="<table width='98%'>";
  $hojaExcel.="<tr>";
    $hojaExcel.="<td width='20%' height='74'>$logo_1</td>";
    $hojaExcel.="<th width='58%'>REGISTRO Y CONTROL DE INVENTARIOS</th>";
