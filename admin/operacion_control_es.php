...
if ($cod_tipo_minuta == 4 || $cod_tipo_minuta == 50 || $cod_tipo_minuta == 18 || $cod_tipo_minuta == 21 || $cod_tipo_minuta == 22 || $cod_tipo_minuta == 59 ||
    $cod_tipo_minuta == 77 || $cod_tipo_minuta == 79 || $cod_tipo_minuta == 80 || $cod_tipo_minuta == 84){
...
if ($cod_tipo_minuta == 10  || $cod_tipo_minuta == 14 || $cod_tipo_minuta == 55){
...
if ($cod_tipo_minuta == 8 || $cod_tipo_minuta == 9  || $cod_tipo_minuta == 14  || $cod_tipo_minuta == 64 || $cod_tipo_minuta == 68 || $cod_tipo_minuta == 75
 || $cod_tipo_minuta == 79 || $cod_tipo_minuta == 80){
...
$hojaExcel.="<table width='100%'>";
  $hojaExcel.="<tr>";
    $hojaExcel.="<td width='33%'><strong>Ciclo de Menú:</strong> &nbsp; $nombre_Menus &nbsp;&nbsp;&nbsp;</td>";
    $hojaExcel.="<td width='33%'>$cad_fecha</td>";
    $hojaExcel.="<td width='33%'><strong>Programa: $nom_tipo_minuta </strong></td>";
  $hojaExcel.="</tr>";
$hojaExcel.="</table>";
