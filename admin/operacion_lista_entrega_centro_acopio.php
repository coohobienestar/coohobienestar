...
if ($cod_tipo_minuta == 3  || $cod_tipo_minuta == 5  || $cod_tipo_minuta == 8  || $cod_tipo_minuta == 9  || $cod_tipo_minuta == 10  || 
    $cod_tipo_minuta == 14){
...
if ($cod_tipo_minuta == 4  || $cod_tipo_minuta == 6  || $cod_tipo_minuta == 7  || $cod_tipo_minuta == 50){
...
$hojaExcel.="<table width='98%' height='80'>";
   $hojaExcel.="<tr>";
    ...
    $hojaExcel.="<td width='20%' rowspan='2' align='center'> $logo_2 </td>";
    $hojaExcel.="</tr>";
    $hojaExcel.="<tr>";
 ...
 $hojaExcel.="<tr>";
      ...
      $instruccion7 ="SELECT calculo_requerimientos.cod_ingrediente AS cod_ingrediente, ingrediente.nombre AS nom_ingrediente, 
                      ...
                      WHERE calculo_requerimientos.cod_programacion = $cod_programacion AND calculo_requerimientos.cod_escuela = $cod_escuela 
                        AND calculo_requerimientos.cod_centro_acopio = $cod_centro_ac AND calculo_requerimientos.cod_modalidad = $cod_modalidad
                        AND calculo_requerimientos.cod_tipo_minuta = $cod_tipo_minuta
