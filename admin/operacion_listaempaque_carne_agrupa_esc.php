...
$condi_municipios = " AND (calculo_requerimientos.cod_municipio = 259)";
  ...
  $instruccion2 ="SELECT DISTINCT calculo_requerimientos.cod_municipio AS cod_municipio, municipio.nombre AS nom_municipio, 
                  ...
                  WHERE calculo_requerimientos.cod_programacion = $cod_programacion AND calculo_requerimientos.cod_departamento = $cod_departamento 
                    AND calculo_requerimientos.cod_tipo_minuta = $cod_tipo_minuta $condi_municipios $condicion
            ...
            $nom_escuela_agr = $row_nom_esc['nombre'];                 
              ...
              $hojaExcel.="<tr>";  
                ...
                for ($l=0; $l<$nfilas4; $l++){
                  ...
                  $cod_ingrediente = $row4['cod_ingrediente'];
                  $valor_gr_cc0 = $row4['valor_gr_cc'];
                  $redondear0 = $row4['redondear'];
                  
                  ////BUSCAMOS LA CANTIDAD DEL INGREDIENTE PARA LA ESCUELA
                  $instruccionq ="SELECT SUM(cantidad) AS cantidad_redondeada
                                  FROM calculo_requerimientos 
                                  WHERE cod_programacion = $cod_programacion AND cod_escuela = $cod_escuela_agr 
                                    AND cod_ingrediente=$cod_ingrediente AND cod_tipo_minuta = $cod_tipo_minuta AND cod_menu = $row4[cod_menu]";
                  ...
                  $cantidad = $cantidad / $valor_gr_cc0;
                  
                   if($redondear0 == 1){
                      ////REDONDEAMOS LAS CANTIDADES DE LA UNIDAD ARITMETICAMENTE
                      $cantidad_r = round($cantidad, 0);
                     }else{
                       ////NO REDONDEAMOS LAS CANTIDADES Y LA DEJAMOS CON UN SOLO DECIMAL
                       $cantidad_r = round($cantidad, 2);
                       }
                  ...
                  if($cantidad_r == '') $cantidad_r = 0;               
                  
                  $hojaExcel.="<td align='center'>$cantidad_r</td>";
                  }          
              $hojaExcel.="</tr>";
              ...
              $hojaExcel.="<tr>";  
                ...
                for ($l=0; $l<$nfilas4; $l++){
                  ...
                  $cod_ingrediente = $row4['cod_ingrediente'];
                  $valor_gr_cc1 = $row4['valor_gr_cc'];
                  $redondear1 = $row4['redondear'];
                  ...
                  $cantidad = $cantidad / $valor_gr_cc1;
                  ...
                  $hojaExcel.="<td align='center'><strong>$cantidad_r</strong></td>";
                  }          
              $hojaExcel.="</tr>";
