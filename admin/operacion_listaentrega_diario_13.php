...
if ($cod_tipo_minuta == 1  || $cod_tipo_minuta == 2  || $cod_tipo_minuta == 5  || $cod_tipo_minuta == 6  || $cod_tipo_minuta == 9  || 
    $cod_tipo_minuta == 10 || $cod_tipo_minuta == 11 || $cod_tipo_minuta == 12 || $cod_tipo_minuta == 13 || $cod_tipo_minuta == 14 || 
    $cod_tipo_minuta == 15 || $cod_tipo_minuta == 23 || $cod_tipo_minuta == 26 || $cod_tipo_minuta == 28 || $cod_tipo_minuta == 29 || 
    $cod_tipo_minuta == 30 || $cod_tipo_minuta == 7  || $cod_tipo_minuta == 16 || $cod_tipo_minuta == 18 || $cod_tipo_minuta == 19 || 
    $cod_tipo_minuta == 24 || $cod_tipo_minuta == 25 || $cod_tipo_minuta == 27 || $cod_tipo_minuta == 32 || $cod_tipo_minuta == 34){
...
if ($cod_tipo_minuta == 3  || $cod_tipo_minuta == 4  || $cod_tipo_minuta == 8  || $cod_tipo_minuta == 17 || $cod_tipo_minuta == 20 ||
    $cod_tipo_minuta == 21 || $cod_tipo_minuta == 22 || $cod_tipo_minuta == 31 || $cod_tipo_minuta == 33){
...
<title>LISTA DE ENTREGA DIARIO v2013</title>
</head>
<body>
<?php
...
$hojaExcel.="<H1 class=SaltoDePagina>";
 ////ENCABEZADO DE LA TABLA DE RESULTADOS
  $hojaExcel.="<table width='98%' height='80'>";
   $hojaExcel.="<tr>";
    $hojaExcel.="<td width='20%' rowspan='2' height='74' align='center'>$logo_1";
    $hojaExcel.="<th width='60%' align='center' height='60'>$encabezado_formato </th>";
    $hojaExcel.="<td width='20%' rowspan='2' align='center'><img src='../imagenes/escudo.png' width='97' height='90' /></td>";
    $hojaExcel.="</tr>";
    $hojaExcel.="<tr>";
...
$hojaExcel.="<table width='98%'>";
 ...
 $hojaExcel.="<tr>";
    $num_complementos = 1 * $cupos_total;
...
$hojaExcel.="<table width='98%' border='1'>";
  $hojaExcel.="<tr>";
    ...
    $hojaExcel.="<td><strong>NOMBRE ENCARGADO DOCENTE ENCARGADO PAE:</strong></td>";
  $hojaExcel.="</tr>";
  $hojaExcel.="<tr>";
...
$hojaExcel.="<table>";   
  ...
  $hojaExcel.="<td width='50%'><strong>NOMBRE ENCARGADO DOCENTE ENCARGADO PAE: </strong></td>";
  $hojaExcel.="</tr>";
  $hojaExcel.="<tr>";
    $hojaExcel.="<td><strong>CARGO:</strong></td>";
    $hojaExcel.="<td rowspan='2'><strong>FIRMA:</strong></td>";
