...
$hojaExcel.="<table width='98%'>";
  ...
  $hojaExcel.="<tr>";
      ...
      for ($i=0; $i<$nfilas6; $i++){
        ...
        $nom_rango = utf8_encode($nom_rango);
  ...
  $hojaExcel.="<tr>";
      ...
      for ($i=0; $i<$nfilas6; $i++){
        ...
        $hojaExcel.="<th colspan='$nfilas_re' align='center'>Cantidad de alimentos por numero de nios en unidad de medida</td>";  
   $hojaExcel.="</tr>";  
  $hojaExcel.="<tr>";
...
$hojaExcel.="<table width='98%'>";
  ...
  $hojaExcel.="</tr>";
  $hojaExcel.="<tr>";
    $hojaExcel.="<td height='30px'>&nbsp;$cad_mun</td>";
  $hojaExcel.="</tr>";
  $hojaExcel.="<tr>";
    $hojaExcel.="<td height='30px'>&nbsp;$cad_esc</td>";
  $hojaExcel.="</tr>";
$hojaExcel.="</table>";
// SECCION FIN OBSERVACIONES
