...
if($tipo_operacion <= 2){
  ...
  if (empty($_REQUEST['nombre']))
    $error=$error . "El Nombre del Centro Zonal no puede estar vacio.<br>";   
...
$nombre    = strtoupper($_REQUEST[nombre]);
  ...
  if($tipo_operacion == 1){
     mysql_query("INSERT INTO centro_zonal (nombre) VALUES ('$nombre')", $conexion);
    }  

  if($tipo_operacion == 2){
     $instruccion4 = "UPDATE centro_zonal SET nombre='$nombre' WHERE cod_centro_zonal = '$codigo'";
