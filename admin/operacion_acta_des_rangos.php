...
/////CONDICION GLOBAL DE LAS PROGRAMACIONES  calculo_requerimientos
$condicion_tab_reque = " (calculo_requerimientos.cod_programacion BETWEEN '$cod_programacion' AND '$cod_programacion2' 
                          ...
                          OR calculo_requerimientos.cod_programacion BETWEEN '$cod_programacion9' AND '$cod_programacion10') ";

/////CONDICION GLOBAL DE LAS PROGRAMACIONES  calculo_redondeado_escuela
$condicion_tab_redon = " (calculo_redondeado_escuela.cod_programacion BETWEEN $cod_programacion AND $cod_programacion2
                          OR calculo_redondeado_escuela.cod_programacion BETWEEN $cod_programacion3 AND $cod_programacion4
                          OR calculo_redondeado_escuela.cod_programacion BETWEEN $cod_programacion5 AND $cod_programacion6
                          OR calculo_redondeado_escuela.cod_programacion BETWEEN $cod_programacion7 AND $cod_programacion8
                          OR calculo_redondeado_escuela.cod_programacion BETWEEN $cod_programacion9 AND $cod_programacion10) "; 

//Numero de programaciones
$cadena_programacion = "ACTA DE DESPACHO <br>";
$cadena_programacion = $cadena_programacion."PROGRAMACIONES No ";

if ($cod_programacion != 0 && $cod_programacion2 != 0)
  $cadena_programacion = $cadena_programacion .' '. $cod_programacion .' A '. $cod_programacion2 . ' - ';
if ($cod_programacion3 != 0 && $cod_programacion4 != 0)
  $cadena_programacion = $cadena_programacion .' '. $cod_programacion3 .' A '. $cod_programacion4 . ' - ';
...
if($cod_centro_acopio !=0){
 $condicion = " WHERE $condicion_tab_reque 
...
$hojaExcel.="<table width='98%' border='1'>";
 ...
 $hojaExcel.="</tr>"; 
  ...
  $instruccion1 ="SELECT DISTINCT calculo_redondeado_escuela.cod_ingrediente AS cod_ingrediente, ingrediente.nombre AS nom_ingrediente,
                  ...
                  INNER JOIN categoria_ingrediente ON categoria_ingrediente.cod_categoria_ingrediente = calculo_redondeado_escuela.cod_categoria_ingrediente
                  INNER JOIN ingrediente_unidad_entrega_consulta ON calculo_redondeado_escuela.cod_ingrediente = ingrediente_unidad_entrega_consulta.cod_ingrediente 
                  AND calculo_redondeado_escuela.cod_unidad_medida = ingrediente_unidad_entrega_consulta.cod_unidad_medida 
                  WHERE $condicion_tab_redon  
...
$hojaExcel.="<table width='98%' border='1'>";
 ...
 $hojaExcel.="</tr>"; 
  ...
  $instruccion1 ="SELECT DISTINCT calculo_redondeado_escuela.cod_ingrediente AS cod_ingrediente, ingrediente.nombre AS nom_ingrediente,
                  ...
                  INNER JOIN ingrediente ON ingrediente.cod_ingrediente = calculo_redondeado_escuela.cod_ingrediente 
                  INNER JOIN unidad_medida ON unidad_medida.cod_unidad_medida = calculo_redondeado_escuela.cod_unidad_medida 
                  INNER JOIN ingrediente_unidad_entrega_consulta ON ingrediente_unidad_entrega_consulta.cod_ingrediente = ingrediente.cod_ingrediente
                  INNER JOIN categoria_ingrediente ON categoria_ingrediente.cod_categoria_ingrediente = calculo_redondeado_escuela.cod_categoria_ingrediente 
                  WHERE $condicion_tab_redon   
