...
$nom_form = " CATEGORIA INGREDIENTE";
...
if($tipo_operacion == 2){
   ...
   $instruccion3 = "SELECT cod_categoria_ingrediente, nombre FROM categoria_ingrediente WHERE cod_categoria_ingrediente = $codigo";
...
<body>
<form action="vr_cat_ingrediente.php" method="post">
