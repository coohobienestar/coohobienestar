...
if($tipo_operacion == 2){
   ...
   $instruccion3 = "SELECT cod_clasificacion, nombre FROM 0c_clasificacion_registro WHERE cod_clasificacion = $codigo";
...
<body>
<form action="vr_clasifica_registro.php" method="post">
