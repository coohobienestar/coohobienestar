...
if($tipo_operacion == 2){
   ...
   $instruccion3 = "SELECT cod_centro_zonal, nombre FROM centro_zonal WHERE cod_centro_zonal = $codigo";
...
<body>
<form action="vr_centro_zonal.php" method="post">
