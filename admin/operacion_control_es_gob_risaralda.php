...
if ($cod_tipo_minuta == 32 || $cod_tipo_minuta == 33 || $cod_tipo_minuta == 37 || $cod_tipo_minuta == 38 || $cod_tipo_minuta == 45){
  $encargado = " DE ENCARGADO: ";
  $prepara  = " UNIDAD DE SERVICIO ";
...
<title>CONTROL ENTRADA Y SALIDA DE ALIMENTOS GOBERNACION DE RISARALDA</title>
</head>
<body>
<?php
////BUSCAMOS LOS MENUS
...
////MINUTAS ALMUERZOS GOBERNACION RISARALDA
if ($cod_tipo_minuta == 38  || $cod_tipo_minuta == 39  || $cod_tipo_minuta == 40  || $cod_tipo_minuta == 41){
...
$hojaExcel.="<table width='98%'>";
  $hojaExcel.="<tr>";
    $hojaExcel.="<td width='17%' height='74' align='center'> $logo_1 </td>";
    $hojaExcel.="<th width='35%'>$nom_formato</th>";
    $hojaExcel.="<td width='48%' align='center'> $logo_2 </td>";
    $hojaExcel.="</tr>";
    $hojaExcel.="</table>";
    $hojaExcel.="<table width='98%'>";
    $hojaExcel.="<tr>";
    $hojaExcel.="<td width='10%'><strong>Departamento</strong></td>";
...
$hojaExcel.="<table width='98%'>";
  $hojaExcel.="<tr>";
    $hojaExcel.="<th colspan='2'>OPERADOR</th>";
    $hojaExcel.="<th colspan='2'>$prepara</th>";
   if($quitar_docente == 1){ 
     $hojaExcel.="<th colspan='2'>UNIDAD DE SERVICIO</th>";
     }
  $hojaExcel.="</tr>";
  $hojaExcel.="<tr>";
...
echo $hojaExcel;
    ...
    $sfile="../excel/FormatoControlES_Gob_risa"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
    $fp=fopen($sfile,"w"); 
    fwrite($fp,$hojaExcel); 
    fclose($fp);
