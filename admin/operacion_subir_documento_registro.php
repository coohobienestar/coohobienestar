...
$nom_formulario = "DOCUMENTO REGISTRO";
...
if($tipo_operacion == 2){
   ...
   $instruccion3 = "SELECT nombre_documento, ult_fecha_revision, cod_clasificacion 
   ...
   $ult_fecha_revision = $row3['ult_fecha_revision'];
   $cod_clasificacion = $row3['cod_clasificacion'];
 } 
...
if($tipo_operacion == 3){
   ...
   ////CONSULTAMOS LOS VALORES ACTUALES DEL REGISTRO
   $instruccion3 = "SELECT nombre_documento FROM 0c_documento_registro WHERE cod_documento = $cod_documento";
   $consulta3 = mysql_query ($instruccion3, $conexion);  
   $row3 = mysql_fetch_array ($consulta3);
...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]               
    ...
    var url="../funciones/upload_docs_registro.php?nombre="+nombre+"&tipo_operacion="+tipo_operacion+"&usuario="+usuario;
...
<body>
<form NAME='datechooser' action="vr_subir_documento_registro.php" method="post">
...
if($tipo_operacion <= 2){
  ...
  if($opcion_vista == 1){      
     print("<tr>");
      ...
      print("<td><img src='../imagenes/requerido.gif'><input type='text' name='nombre' size='40' maxlength='100' value='$nombre_documento'></td>");   
     print("</tr>");         
    print("<tr>");
      print ("<td align='left' style='font-weight:bold; color: white'>Fecha Documento</td>");
      print ("<td><img width='18' height='18' src='../imagenes/calendar.png'><INPUT type='text' name='fecha_ult' onfocus='doShow(\"datechooser1\",\"datechooser\",\"fecha_ult\")' value='$ult_fecha_revision'><div enabled='false' id='datechooser1'></div></td>");
     print("</tr>");  
     print("<tr>");  
      ...
      $instruccion = "SELECT cod_clasificacion, nombre FROM 0c_clasificacion_registro ORDER BY nombre";
      ...
      $row = mysql_fetch_array ($consulta); 
        ...
        do{ 
          if($row['cod_clasificacion'] == $cod_clasificacion){
     ...
     print("</tr>");      
     print("<tr>");
     print("<td align='center' width='100%' colspan='6' height='34'><input type='submit' value='Registrar Documento'></td>");
     print("</tr>");   
    } 
...
if($tipo_operacion == 3){
    ...
    print ("<tr><td colspan='5' style='font-weight:bold; color: white'> $nombre_documento</td></tr>");
    ...
    $nfilas = mysql_num_rows ($consulta6);
     ...
     if($nfilas>0){
      do{           
        ...
        $instruccion6a = "SELECT cod_documento, cod_usuario FROM 0c_usuario_documento_registro WHERE cod_usuario = $cod_usuario AND cod_documento = $cod_documento";
...
/////ELIMINAR DOCUMENTOS MARCAR COMO OBSOLETO
if($tipo_operacion == 4){
     print("<tr>");
     print("<td style='font-weight:bold; font-size: 10pt; color: white' align='center' width='100%' colspan='6' height='34'>Realmente desea Eliminar el documento:<br> $nombre_documento?</td>");
     print("</tr>");  
