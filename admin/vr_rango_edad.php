...
if($tipo_operacion <= 2){
  ...
  if (empty($_REQUEST['nombre']))
    $error=$error . "El Nombre del Rango de Edad no puede estar vacio.<br>";   
...
$nombre    = strtoupper($_REQUEST[nombre]);
  ...
  if($tipo_operacion == 1){
     mysql_query("INSERT INTO rango_edad (nombre) VALUES ('$nombre')", $conexion);
    }  

  if($tipo_operacion == 2){
     $instruccion4 = "UPDATE rango_edad SET nombre='$nombre' WHERE cod_rango_edad = '$codigo'";
