...
if($tipo_operacion == 2){
   ...
   $instruccion3 = "SELECT cod_unidad_medida, nombre, valor_gr_cc FROM unidad_medida WHERE cod_unidad_medida = $codigo";
   $consulta3 = mysql_query ($instruccion3, $conexion);  
   $row3 = mysql_fetch_array ($consulta3);

   $cod_unidad_medida  = $row3['cod_unidad_medida'];  
   $nombre    = $row3['nombre']; 
   $valor_gr_cc = $row3['valor_gr_cc'];
...
<body>
<form action="vr_unidad_medida.php" method="post">
...
?> 
  ...
  <tr>
   <td style='font-weight:bold; color: white'>Valor GR/CC</td>
   <td><img src="../imagenes/requerido.gif"><input type="text" name="valor_gr_cc" size="10" value='<?php print("$valor_gr_cc");?>'></td>   
  </tr>   
  <tr>
