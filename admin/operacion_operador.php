...
if($tipo_operacion == 2){
   ...
   $instruccion3 = "SELECT cod_operador, nombre, nit, logo FROM operador WHERE cod_operador = $codigo";
...
<body>
<form action="vr_operador.php" method="post">
...
?> 
  ...
  <tr>
   <td style='font-weight:bold; color: white'>Nit</td>
   <td><img src="../imagenes/requerido.gif"><input type="text" name="nit" size="15" value='<?php print("$nit");?>'></td>   
  </tr>   
  <tr>
   <td style='font-weight:bold; color: white'>Logo</td>
   <td><img src="../imagenes/requerido.gif"><input <?php print("$disabled");?> type="text" name="logo" size="15" value='<?php print("$logo");?>'></td>   
  </tr> 
  <tr>
