...
if($tipo_operacion == 2){
   ...
   $instruccion3 = "SELECT cod_centro_acopio, nombre, grupo FROM centro_acopio WHERE cod_centro_acopio = $codigo";
...
<body>
<form action="vr_centro_acopio.php" method="post">
...
?> 
  ...
  <tr>
   <td style='font-weight:bold; color: white'>Grupo</td>
   <td><img src="../imagenes/requerido.gif"><input type="text" name="grupo" size="3" value='<?php print("$grupo");?>'></td>   
  </tr>  
  <tr>
