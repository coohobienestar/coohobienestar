...
$cod_centro_ac = $_GET['cod_centro_acopio'];
...
*/
 ...
 if($cod_centro_ac != 0){
  $condicion = " WHERE calculo_requerimientos.cod_programacion = $cod_programacion AND calculo_requerimientos.cod_centro_acopio = $cod_centro_ac 
                   AND calculo_requerimientos.cod_modalidad = $cod_modalidad AND calculo_requerimientos.cod_tipo_minuta = $tipo";
  } 
...
*/
  ...
  $instruccion2 ="SELECT DISTINCT calculo_requerimientos.cod_ciclo AS cod_ciclo, ciclo.nombre AS nom_ciclo, calculo_requerimientos.cod_escuela AS cod_escuela, 
                  ...
                  WHERE calculo_requerimientos.cod_programacion = $cod_programacion AND calculo_requerimientos.cod_centro_acopio = $cod_centro_ac 
  ...
  $instruccion_re ="SELECT DISTINCT calculo_requerimientos.cod_rango_edad AS cod_rango_edad, rango_edad.nombre AS nombre
                    ...
                    WHERE calculo_requerimientos.cod_programacion = $cod_programacion AND calculo_requerimientos.cod_modalidad = $cod_modalidad
                      AND calculo_requerimientos.cod_centro_acopio = $cod_centro_ac AND calculo_requerimientos.cod_escuela = $cod_escuela 
                      AND calculo_requerimientos.cod_tipo_minuta = $cod_tipo_minuta";
  ...
  $columnas = 14 + ($nfilas_re * 1); ////6 numero de columnas fijas mas las de rango de edad variables por 2 veces q se deben dibujar
...
<title>LISTA DE ENTREGA POR CENTRO DE ACOPIO PAE v.2015</title>
</head>
<body>
<?php     
...
$logo   = "<img src='../imagenes/$logo' width='134' height='60' />";
...
if ($cod_tipo_minuta == 65 || $cod_tipo_minuta == 66 || $cod_tipo_minuta == 67){
    $logo_4 = "<img src='../imagenes/esc_tolima.jpg' width='60' height='60' /><img src='../imagenes/tolima02.png' width='50' height='50' /><img src='../imagenes/alc_melgar.png' width='50' height='50' />";
  }   
////Quindio
...
if ($cod_tipo_minuta == 4 || $cod_tipo_minuta == 50 || $cod_tipo_minuta == 18 || $cod_tipo_minuta == 21 || $cod_tipo_minuta == 22 || $cod_tipo_minuta == 59 || 
    $cod_tipo_minuta == 87 || $cod_tipo_minuta == 88 || $cod_tipo_minuta == 89 || $cod_tipo_minuta == 93 || $cod_tipo_minuta == 94 || $cod_tipo_minuta == 95 || 
    $cod_tipo_minuta == 96 || $cod_tipo_minuta == 97){
...
if ($cod_tipo_minuta == 3 || $cod_tipo_minuta == 16 || $cod_tipo_minuta == 19 || $cod_tipo_minuta == 23 || $cod_tipo_minuta == 17 || $cod_tipo_minuta == 20 ||
    ...
    $cod_tipo_minuta == 72 || $cod_tipo_minuta == 73 || $cod_tipo_minuta == 85 || $cod_tipo_minuta == 86 || $cod_tipo_minuta == 90 || $cod_tipo_minuta == 92){

 if($cod_tipo_minuta == 17 || $cod_tipo_minuta == 20 || $cod_tipo_minuta == 58 || $cod_tipo_minuta == 65){
 ...
 if($cod_tipo_minuta == 3 || $cod_tipo_minuta == 16 || $cod_tipo_minuta == 19 || $cod_tipo_minuta == 23 || $cod_tipo_minuta == 57 || $cod_tipo_minuta == 61
   || $cod_tipo_minuta == 66 || $cod_tipo_minuta == 67 || $cod_tipo_minuta == 72){
