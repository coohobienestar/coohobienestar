...
$num_observacion = $_GET['observacion'];
...
if($tipo_operacion == 1){
   $nom_form = " OBSERVACION A LA PROGRAMACION";
 }

if($tipo_operacion == 2){
   $nom_form = " OBSERVACION A UN MUNICIPIO";
 } 
 
if($tipo_operacion == 3){
   $nom_form = " OBSERVACION A UNA ESCUELA";
 }    
if($tipo_operacion == 7){
  $icono = "guardar.png";
  $nom_operacion = "REGISTRAR ";
  $nom_form = " OBSERVACION DE INTERCAMBIO";
...
<body>
<form action="vr_observacion.php" method="post">
