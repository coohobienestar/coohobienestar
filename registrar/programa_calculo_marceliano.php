...
<html>
<head>
<title>PROGRAMAR MARCELIANO</title>
<?php
...
<br>
<body>
<form NAME='datechooser' action="valida_programa_calculo_marceliano.php" method="post">
...
<table width="70%" align="Center" border = "0">
  <tr>
    <th colspan=5><div align="center"><strong>PROGRAMACION DE CICLO A CALCULAR PARA MARCELIANO</strong></div></th>
  </tr>
    <?php 
  ...
  <tr>
   <?php
    ////BUSCAMOS LOS CICLOS DEL SISTEMA LOS USADOS PARA PROGRAMAR NO EL CICLO MATRIZ
      ...
      $instruccion = "SELECT cod_ciclo, nombre FROM ciclo WHERE cod_ciclo BETWEEN 953 AND 956 ORDER BY cod_ciclo";
      $consulta = mysql_query ($instruccion, $conexion);
  ...
  <tr>
    ...
    <?php
      ...
      $instruccion6 = "SELECT DISTINCT menu.cod_menu AS cod_menu, menu.nombre AS nombre
                       ...
                       WHERE plato_ingrediente.cod_minuta BETWEEN 9992 AND 9997
   ...
   <?php
    ////BUSCAMOS LAS PROGRAMCIONES DEL SISTEMA
      ...
      $instruccion = "SELECT DISTINCT programacion.cod_programacion AS cod_programacion, ciclo.nombre AS nombre
                      ...
                      WHERE programacion.estado = 1 AND programacion.cod_ciclo BETWEEN 953 AND 956
