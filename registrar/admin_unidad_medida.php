...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_unidad_medida.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
   ...
   function actualizaPagina (){
      ...
      window.location = 'admin_unidad_medida.php?codigo='+codigo+'&nombre='+nombre+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Registrar Unidad de Medida</a></td>
<?php } ?>
...
<?php                        
      ...
      $instruccion3 = "SELECT count(cod_unidad_medida) AS cuenta FROM unidad_medida";
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_unidad_medida.php' METHOD='POST'>");
      ...
      if($codigo != ''){
         $condicion2 = $condicion2. "unidad_medida.cod_unidad_medida like '%$codigo%' AND ";
        }
      if($nombre != ''){
         $condicion2 = $condicion2. "unidad_medida.nombre like '%$nombre%' AND ";
        } 
      ...
      $instruccion2 ="SELECT unidad_medida.cod_unidad_medida AS cod_unidad_medida, unidad_medida.nombre AS nom_unidad_medida, unidad_medida.valor_gr_cc AS valor_gr_cc
                      FROM unidad_medida 
                      $condicion_final 
                      ORDER BY unidad_medida.cod_unidad_medida
                      $limit  
                      ";
      ...
      $hojaExcel.="<TR><TH colspan='9'><center>UNIDADES DE MEDIDA</center></TH></TR>";       
      $hojaExcel.="<TH><center>Código</center></TH>";
      $hojaExcel.="<TH><center>Nombre</center></TH>";
      $hojaExcel.="<TH><center>Valor en GR/CC</center></TH>";
    if($opcion_vista == 1){
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            $hojaExcel.="<TD style=background:$color>" . $row2['valor_gr_cc'] . "</TD>";
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_unidad_medida],2) title='Editar Unidad MEdida'><img src='../imagenes/editar.png' width='14' height='14' border='0' alt='Editar'></a> </center></TD>"; 
            } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
         echo $hojaExcel;
          ...
          $sfile="../excel/UnidadMedida"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
