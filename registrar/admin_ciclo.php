...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_ciclo.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
   ...
   function actualizaPagina (){
      ...
      window.location = 'admin_ciclo.php?codigo='+codigo+'&nombre='+nombre+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Registrar Ciclo</a></td>
<?php } ?>
...
<?php                        
      ...
      $instruccion3 = "SELECT count(cod_ciclo) AS cuenta FROM ciclo";
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_ciclo.php' METHOD='POST'>");
      ...
      if($codigo != ''){
         $condicion2 = $condicion2. "ciclo.cod_ciclo like '%$codigo%' AND ";
        }
      if($nombre != ''){
         $condicion2 = $condicion2. "ciclo.nombre like '%$nombre%' AND ";
        } 
      ...
      $instruccion2 ="SELECT ciclo.cod_ciclo AS cod_ciclo, ciclo.nombre AS nombre
                      FROM ciclo
                      $condicion_final 
                      ORDER BY ciclo.cod_ciclo
                      $limit  
                      ";
      ...
      $hojaExcel.="<TR><TH colspan='9'><center>CICLOS</center></TH></TR>";       
    ...
    if($opcion_vista == 1){
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
          ...
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_ciclo],2) title='Editar Ciclo'><img src='../imagenes/editar.png' width='14' height='14' border='0' alt='Editar'></a> </center></TD>"; 
            } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
         echo $hojaExcel;
          ...
          $sfile="../excel/Ciclo"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
