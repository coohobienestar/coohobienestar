...
<html>
<head>
<title>PROGRAMAR CICLO A ALMUERZOS GOB RISARALDA</title>
<?php
...
<table width="70%" align="Center" border = "0">
  <tr>
    <th colspan=5><div align="center"><strong>PROGRAMACION DE CICLO A CALCULAR PARA ALMUERZO GOB RISARALDA</strong></div></th>
  </tr>
    <?php 
  ...
  <tr>
    ...
    <?php
      ...
      $instruccion6 = "SELECT DISTINCT menu.cod_menu AS cod_menu, menu.nombre AS nombre
                       ...
                       WHERE plato_ingrediente.cod_minuta BETWEEN 9955 AND 9962
   ...
   <?php
    ////BUSCAMOS LAS PROGRAMCIONES DEL SISTEMA
      ...
      $instruccion = "SELECT DISTINCT programacion.cod_programacion AS cod_programacion, ciclo.nombre AS nombre
                      ...
                      WHERE programacion.estado = 1 AND programacion.cod_ciclo BETWEEN 934 AND 941
