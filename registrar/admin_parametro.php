...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_parametro.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
    open(url,"Sizewindow","width=1300,height=300,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }
   ...
   function actualizaPagina (){
      ...
      window.location = 'admin_parametro.php?codigo='+codigo+'&nombre='+nombre+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php                        
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_parametro.php' METHOD='POST'>");
      print ("<TR style='font-weight:bold; color: white'>");
      print ("<TD>Nombre ");
      print ("<INPUT type='text' name='codigo' size='30' value=''></TD>");
      print ("<TD>Descripción ");
      ...
      if($codigo != ''){
         $condicion2 = $condicion2. "parametro.nombre like '%$codigo%' AND ";
        }
      if($nombre != ''){
         $condicion2 = $condicion2. "parametro.descripcion like '%$nombre%' AND ";
        } 
      ...
      $instruccion2 ="SELECT parametro.nombre AS nombre, parametro.valor AS valor, parametro.descripcion AS descripcion, parametro.modificable AS modificable
                      FROM parametro
                      $condicion_final 
      ...
      $hojaExcel.="<TR><TH colspan='9'><center>PARAMETROS</center></TH></TR>";       
      $hojaExcel.="<TH><center>Nombre</center></TH>";
      $hojaExcel.="<TH><center>Valor</center></TH>";
      $hojaExcel.="<TH><center>Descripcion</center></TH>";
      $hojaExcel.="<TH><center>Modificable</center></TH>";
    if($opcion_vista == 1){
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            $hojaExcel.="<TD style=background:$color>" . $row2['valor'] . "</TD>";
            $hojaExcel.="<TD style=background:$color>" . $row2['descripcion'] . "</TD>";
            $hojaExcel.="<TD style=background:$color>" . $modificable . "</TD>";
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla('$row2[nombre]',2) title='Editar Parametro'><img src='../imagenes/editar.png' width='14' height='14' border='0' alt='Editar'></a> </center></TD>"; 
            } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
         echo $hojaExcel;
          ...
          $sfile="../excel/Parametro"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
