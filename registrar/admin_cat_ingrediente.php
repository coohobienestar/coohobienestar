...
<HEAD>
<TITLE>CATEGORIA INGREDIENTE</TITLE>
...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_cat_ingrediente.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
   ...
   function actualizaPagina (){
      ...
      window.location = 'admin_cat_ingrediente.php?codigo='+codigo+'&nombre='+nombre+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Registrar Categoria</a></td>
<?php } ?>
...
<?php                        
      ...
      $instruccion3 = "SELECT count(cod_categoria_ingrediente) AS cuenta FROM categoria_ingrediente";
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_cat_ingrediente.php' METHOD='POST'>");
      ...
      if($codigo != ''){
         $condicion2 = $condicion2. "categoria_ingrediente.cod_categoria_ingrediente like '%$codigo%' AND ";
        }
      if($nombre != ''){
         $condicion2 = $condicion2. "categoria_ingrediente.nombre like '%$nombre%' AND ";
        } 
      ...
      $instruccion2 ="SELECT categoria_ingrediente.cod_categoria_ingrediente AS cod_categoria_ingrediente, categoria_ingrediente.nombre AS nombre
                      FROM categoria_ingrediente
                      $condicion_final 
                      ORDER BY categoria_ingrediente.cod_categoria_ingrediente
                      $limit  
                      ";
      ...
      $hojaExcel.="<TR><TH colspan='9'><center>CATEGORIAS INGREDIENTES</center></TH></TR>";       
    ...
    if($opcion_vista == 1){
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
          ...
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_categoria_ingrediente],2) title='Editar Categoria'><img src='../imagenes/editar.png' width='14' height='14' border='0' alt='Editar'></a> </center></TD>"; 
            } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
         echo $hojaExcel;
          ...
          $sfile="../excel/Categorias"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
