    ...
    if($opcion_vista == 1){
      ...
      $color = '';
         ...
         for($i=0; $i<$nfilas; $i++){
            ...
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_programacion],1) title='Ver observaciones de la programación'><img src='../imagenes/observacion.png' width='16' height='16' border='0' alt=''></a> </center></TD>"; 
          if($opcion_vista == 1){  
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_programacion],2) title='Activar / Desactivar programación'><img src='../imagenes/act_desact.png' width='16' height='16' border='0' alt=''></a> </center></TD>";                         
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_programacion],3) title='Eliminar programación'><img src='../imagenes/borrar.png' width='16' height='16' border='0' alt=''></a> </center></TD>";
             }
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
