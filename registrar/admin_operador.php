...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_operador.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
    open(url,"Sizewindow","width=700,height=300,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }
   ...
   function actualizaPagina (){
      ...
      window.location = 'admin_operador.php?codigo='+codigo+'&nombre='+nombre+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Registrar Operador</a></td>
<?php } ?>
...
<?php                        
      ...
      $instruccion3 = "SELECT count(cod_operador) AS cuenta FROM operador";
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_operador.php' METHOD='POST'>");
      ...
      if($codigo != ''){
         $condicion2 = $condicion2. "operador.cod_operador like '%$codigo%' AND ";
        }
      if($nombre != ''){
         $condicion2 = $condicion2. "operador.nombre like '%$nombre%' AND ";
        } 
      ...
      $instruccion2 ="SELECT operador.cod_operador AS cod_operador, operador.nombre AS nombre, operador.nit AS nit, operador.logo AS logo
                      FROM operador
                      $condicion_final 
                      ORDER BY operador.cod_operador
                      $limit  
                      ";
      ...
      $hojaExcel.="<TR><TH colspan='9'><center>OPERADOR</center></TH></TR>";       
      $hojaExcel.="<TH><center>Código</center></TH>";
      $hojaExcel.="<TH><center>Nombre</center></TH>";
      $hojaExcel.="<TH><center>Nit</center></TH>";
      $hojaExcel.="<TH><center>Logo</center></TH>";
    if($opcion_vista == 1){
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            $hojaExcel.="<TD style=background:$color>" . $row2['nit'] . "</TD>";
            $hojaExcel.="<TD style=background:$color>" . $row2['logo'] . "</TD>";
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_operador],2) title='Editar Operador'><img src='../imagenes/editar.png' width='14' height='14' border='0' alt='Editar'></a> </center></TD>"; 
            } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
         echo $hojaExcel;
          ...
          $sfile="../excel/Operador"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
