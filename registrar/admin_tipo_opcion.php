...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_tipo_opcion.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
   ...
   function actualizaPagina (){
      ...
      window.location = 'admin_tipo_opcion.phpcodigo='+codigo+'&nombre='+nombre+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Registrar Tipo de Opción</a></td>
<?php } ?>
...
<?php                        
      ...
      $instruccion3 = "SELECT count(cod_tipo_opcion) AS cuenta FROM tipo_opcion";
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_tipo_opcion.php' METHOD='POST'>");
      ...
      if($codigo != ''){
         $condicion2 = $condicion2. "tipo_opcion.cod_tipo_opcion like '%$codigo%' AND ";
        }
      if($nombre != ''){
         $condicion2 = $condicion2. "tipo_opcion.nombre like '%$nombre%' AND ";
        } 
      ...
      $instruccion2 ="SELECT tipo_opcion.cod_tipo_opcion AS cod_tipo_opcion, tipo_opcion.nombre AS nom_tipo_opcion
                      FROM tipo_opcion 
                      $condicion_final 
                      ORDER BY tipo_opcion.cod_tipo_opcion
                      $limit  
                      ";
      ...
      $hojaExcel.="<TR><TH colspan='9'><center>TIPOS DE OPCIÓN</center></TH></TR>";       
    ...
    if($opcion_vista == 1){
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
          ...
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_tipo_opcion],2) title='Editar Tipo Opcion'><img src='../imagenes/editar.png' width='14' height='14' border='0' alt='Editar'></a> </center></TD>"; 
            } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
         echo $hojaExcel;
          ...
          $sfile="../excel/TipoOpcion"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
