...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_tipo_minuta.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
   ...
   function actualizaPagina (){
      ...
      i = document.forms.datechooser.modalidad.selectedIndex;
      modalidad = document.forms.datechooser.modalidad.options[i].value;
      
      k = document.forms.datechooser.pagina.selectedIndex;
      pagina = document.forms.datechooser.pagina.options[k].value;
            
      window.location = 'admin_tipo_minuta.php?modalidad='+modalidad+'&codigo='+codigo+'&nombre='+nombre+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Registrar Tipo de Minuta</a></td>
<?php } ?>
...
<?php                        
      ...
      $instruccion3 = "SELECT count(cod_tipo_minuta) AS cuenta FROM tipo_minuta";
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_tipo_minuta.php' METHOD='POST'>");
      ...
      if($codigo != ''){
         $condicion2 = $condicion2. "tipo_minuta.cod_tipo_minuta like '%$codigo%' AND ";
        }
      if($nombre != ''){
         $condicion2 = $condicion2. "tipo_minuta.nombre like '%$nombre%' AND ";
        } 
      if($modalidad != ''){
         $condicion2 = $condicion2. "tipo_minuta.cod_modalidad = '$modalidad' AND ";
        }   
      ...
      $instruccion2 ="SELECT tipo_minuta.cod_tipo_minuta AS cod_tipo_minuta, tipo_minuta.nombre AS nom_tipo_minuta, modalidad.cod_modalidad AS cod_modalidad, 
                             modalidad.nombre AS nom_modalidad
                      FROM tipo_minuta 
                      INNER JOIN modalidad ON modalidad.cod_modalidad = tipo_minuta.cod_modalidad
                      $condicion_final 
                      ORDER BY tipo_minuta.cod_tipo_minuta
                      $limit  
                      ";
      ...
      $hojaExcel.="<TR><TH colspan='9'><center>TIPOS DE MINUTA</center></TH></TR>";       
      $hojaExcel.="<TH><center>Código</center></TH>";
      $hojaExcel.="<TH><center>Nombre</center></TH>";
      $hojaExcel.="<TH colspan='2'><center>Modalidad</center></TH>";
    if($opcion_vista == 1){
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            $hojaExcel.="<TD style=background:$color>" . $row2['cod_modalidad'] . "</TD>";
            $hojaExcel.="<TD style=background:$color>" . $row2['nom_modalidad'] . "</TD>";
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_tipo_minuta],2) title='Editar Tipo Minuta'><img src='../imagenes/editar.png' width='14' height='14' border='0' alt='Editar'></a> </center></TD>"; 
            } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
         echo $hojaExcel;
          ...
          $sfile="../excel/TipoMinuta"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
