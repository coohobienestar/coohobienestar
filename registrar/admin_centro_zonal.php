...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_centro_zonal.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
   ...
   function actualizaPagina (){
      ...
      window.location = 'admin_centro_zonal.php?codigo='+codigo+'&nombre='+nombre+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Registrar Centro Zonal</a></td>
<?php } ?>
...
<?php                        
      ...
      $instruccion3 = "SELECT count(cod_centro_zonal) AS cuenta FROM centro_zonal";
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_centro_zonal.php' METHOD='POST'>");
      ...
      if($codigo != ''){
         $condicion2 = $condicion2. "centro_zonal.cod_centro_zonal like '%$codigo%' AND ";
        }
      if($nombre != ''){
         $condicion2 = $condicion2. "centro_zonal.nombre like '%$nombre%' AND ";
        } 
      ...
      $instruccion2 ="SELECT centro_zonal.cod_centro_zonal AS cod_centro_zonal, centro_zonal.nombre AS nombre
                      FROM centro_zonal
                      $condicion_final 
                      ORDER BY centro_zonal.cod_centro_zonal
                      $limit  
                      ";
      ...
      $hojaExcel.="<TR><TH colspan='9'><center>CENTRO ZONAL</center></TH></TR>";       
    ...
    if($opcion_vista == 1){
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
          ...
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_centro_zonal],2) title='Editar Centro Zonal'><img src='../imagenes/editar.png' width='14' height='14' border='0' alt='Editar'></a> </center></TD>"; 
            } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
         echo $hojaExcel;
          ...
          $sfile="../excel/CentroZonales"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
