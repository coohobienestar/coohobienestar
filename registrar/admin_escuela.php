...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_escuela.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
    open(url,"Sizewindow","width=800,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }
   ...
   function actualizaPagina (){
      ...
      nommun = document.forms.datechooser.nommun.value
      
      window.location = 'admin_escuela.php?c_acopio='+c_acopio+'&codigo='+codigo+'&nombre='+nombre+'&municipio='+municipio+'&nommun='+nommun+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Registrar Escuela</a></td>
<?php } ?>
...
<?php                        
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_escuela.php' METHOD='POST'>");
      print ("<TR style='font-weight:bold; color: white'>");
      print ("<TD>C�digo ");
      print ("<INPUT type='text' name='codigo' value='' size='3'></TD>");
      print ("<TD>Nombre ");
      ...
      print ("<TD>Nombre ");
      print ("<INPUT type='text' name='nommun' value=''></TD>");   
      ...
      if($codigo != ''){
         $condicion2 = $condicion2. "escuela.cod_escuela = '$codigo' AND ";
        }
      if($nombre != ''){
      ...
      $instruccion2 =" SELECT escuela.cod_escuela AS cod_escuela, escuela.nombre AS esc_nombre, escuela.cod_centro_acopio AS cod_centro_acopio, 
                              ...
                              escuela.cod_escuela_agrupada AS cod_escuela_agrupada
                       FROM escuela 
      ...
      $hojaExcel.="<TR><TH colspan='8'><center>ESCUELAS</center></TH></TR>";       
      ...
      $hojaExcel.="<TH colspan='2'><center>Agrupada Con</center></TH>";
    if($opcion_vista == 1){
      $hojaExcel.="<TH><center>Editar</center></TH>";
      $hojaExcel.="<TH><center>Relacionar Minuta</center></TH>";
     }
      $hojaExcel.="</TR>";
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            if($row2['cod_escuela_agrupada'] > 0){
              ////BUSCAMOS EL NOMBRE DE LA ESCUELA AGRUPADA
              $instruccion_esc_agr = "SELECT nombre FROM escuela WHERE cod_escuela = $row2[cod_escuela_agrupada]";
              $consulta_esc_agr = mysql_query ($instruccion_esc_agr, $conexion);  
              $row_esc_agr = mysql_fetch_array ($consulta_esc_agr);
              $nom_escuela_agrupada = $row_esc_agr['nombre']; 
             }else{
               $nom_escuela_agrupada = '';
               $row2[cod_escuela_agrupada] = '';
               } 
            ...
            $hojaExcel.="<TD style=background:$color>" . $row2['cod_escuela_agrupada'] . "</TD>";
            $hojaExcel.="<TD style=background:$color>" . $nom_escuela_agrupada . "</TD>";
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_escuela],2)><img src='../imagenes/editar.png' width='14' height='14' border='0' alt='Editar'></a> </center></TD>"; 
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_escuela],3)><img src='../imagenes/relacionar.png' width='14' height='14' border='0' alt='Relacionar'></a> </center></TD>";            
           } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
         echo $hojaExcel;
          ...
          $sfile="../excel/Escuelas"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
