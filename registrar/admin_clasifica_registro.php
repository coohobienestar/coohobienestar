...
<HEAD>
<TITLE>CLASIFICACION REGISTRO DOCUMENTOS</TITLE>
...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_clasifica_registro.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
   ...
   function actualizaPagina (){
      ...
      window.location = 'admin_clasifica_registro.php?codigo='+codigo+'&nombre='+nombre+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Registrar Clasificacion</a>
...
<?php                        
      ...
      $instruccion3 = "SELECT count(cod_clasificacion) AS cuenta FROM 0c_clasificacion_registro";
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_clasifica_registro.php' METHOD='POST'>");
      ...
      if($codigo != ''){
         $condicion2 = $condicion2. "0c_clasificacion_registro.cod_clasificacion = '$codigo' AND ";
        }
      if($nombre != ''){
         $condicion2 = $condicion2. "0c_clasificacion_registro.nombre like '%$nombre%' AND ";
        } 
      ...
      $instruccion2 ="SELECT 0c_clasificacion_registro.cod_clasificacion AS cod_clasificacion, 0c_clasificacion_registro.nombre AS nombre
                      FROM 0c_clasificacion_registro
                      $condicion_final 
                      ORDER BY 0c_clasificacion_registro.cod_clasificacion
                      $limit  
                      ";
      ...
      $hojaExcel.="<TR><TH colspan='9'><center>CLASIFICACION DOCUMENTOS</center></TH></TR>";       
    ...
    if($opcion_vista == 1){
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            $hojaExcel.="<TR>";
            $hojaExcel.="<TD style=background:$color>" . $row2['cod_clasificacion'] . "</TD>";
            $hojaExcel.="<TD style=background:$color>" . $row2['nombre'] . "</TD>";
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_clasificacion],2) title='Editar Clasificacion'><img src='../imagenes/editar.png' width='14' height='14' border='0' alt='Editar'></a> </center></TD>"; 
            } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
         echo $hojaExcel;
          ...
          $sfile="../excel/Clasificacion"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
