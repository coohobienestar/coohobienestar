...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_municipio.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
    open(url,"Sizewindow","width=1200,height=800,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }
   ...
   function actualizaPagina (){
      ...
      l = document.forms.datechooser.centroz.selectedIndex;
      centroz = document.forms.datechooser.centroz.options[l].value;
      
      k = document.forms.datechooser.pagina.selectedIndex;
      pagina = document.forms.datechooser.pagina.options[k].value;
            
      window.location = 'admin_municipio.php?departamento='+departamento+'&codigo='+codigo+'&nombre='+nombre+'&pagina='+pagina+'&centroz='+centroz;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Registrar Municipio</a></td>
<?php } ?>
...
<?php                        
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_municipio.php' METHOD='POST'>");
      ...
      print ("<TD>Centro Zonal ");
      print ("<SELECT NAME='centroz'>");                
      ...
      if($nombre != ''){
         $condicion2 = $condicion2. "municipio.nombre like '%$nombre%' AND ";
        } 
      if($departamento != ''){
         $condicion2 = $condicion2. "municipio.cod_departamento = '$departamento' AND ";
        } 
      if($centroz != ''){
         $condicion2 = $condicion2. "municipio.cod_centro_zonal = '$centroz' AND ";
        }          
      ...
      $instruccion2 ="SELECT municipio.cod_municipio AS cod_municipio, municipio.nombre AS nom_municipio, municipio.cod_departamento AS cod_departamento, 
                             departamento.nombre AS nom_departamento, municipio.cod_centro_zonal AS cod_centro_zonal, 
                             centro_zonal.nombre AS nom_centro_zonal
                      FROM departamento 
                      INNER JOIN municipio ON departamento.cod_departamento = municipio.cod_departamento
      ...
      $hojaExcel.="<TR><TH colspan='9'><center>MUNICIPIOS</center></TH></TR>";       
      $hojaExcel.="<TH><center>Código</center></TH>";
      $hojaExcel.="<TH><center>Nombre</center></TH>";
      $hojaExcel.="<TH colspan='2'><center>Departamento</center></TH>";
      $hojaExcel.="<TH colspan='2'><center>Centro Zonal</center></TH>";
    if($opcion_vista == 1){
      $hojaExcel.="<TH><center>Editar</center></TH>";
      $hojaExcel.="<TH><center>Cambiar Minutas</center></TH>";
     }
      $hojaExcel.="</TR>";
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            $hojaExcel.="<TD style=background:$color>" . $row2['cod_departamento'] . "</TD>";
            $hojaExcel.="<TD style=background:$color>" . $row2['nom_departamento'] . "</TD>";
            $hojaExcel.="<TD style=background:$color>" . $row2['cod_centro_zonal'] . "</TD>";
            $hojaExcel.="<TD style=background:$color>" . $row2['nom_centro_zonal'] . "</TD>";
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_municipio],2) title='Editar Municipio'><img src='../imagenes/editar.png' width='14' height='14' border='0' alt=''></a> </center></TD>"; 
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_municipio],3) title='Cambiar minutas al municipio $row2[nom_municipio]'><img src='../imagenes/relacionar.png' width='14' height='14' border='0' alt=''></a> </center></TD>";
            } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
