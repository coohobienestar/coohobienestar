...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_centro_acopio.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
   ...
   function actualizaPagina (){
      ...
      j = document.forms.datechooser.grupo.selectedIndex;
      grupo = document.forms.datechooser.grupo.options[j].value;
      
      k = document.forms.datechooser.pagina.selectedIndex;
      pagina = document.forms.datechooser.pagina.options[k].value;
            
      window.location = 'admin_centro_acopio.php?codigo='+codigo+'&nombre='+nombre+'&grupo='+grupo+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Registrar Centro de Acopio</a></td>
<?php } ?>
...
<?php                        
      ...
      $instruccion3 = "SELECT count(cod_centro_acopio) AS cuenta FROM centro_acopio";
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_centro_acopio.php' METHOD='POST'>");
      ...
      $instruccion = "SELECT DISTINCT grupo FROM centro_acopio ORDER BY grupo";
      ...
      $descp = "--";
        ...
        do{ 
           print("<option value=".$row['grupo'].">".$row['grupo']."</option>");
      ...
      if($codigo != ''){
         $condicion2 = $condicion2. "centro_acopio.cod_centro_acopio like '%$codigo%' AND ";
        }
      if($nombre != ''){
         $condicion2 = $condicion2. "centro_acopio.nombre like '%$nombre%' AND ";
        } 
      if($grupo != ''){
         $condicion2 = $condicion2. "centro_acopio.grupo = '$grupo' AND ";
        } 
      ...
      $instruccion2 ="SELECT centro_acopio.cod_centro_acopio AS cod_centro_acopio, centro_acopio.nombre AS nombre, centro_acopio.grupo AS grupo
                      FROM centro_acopio
                      $condicion_final 
                      ORDER BY centro_acopio.cod_centro_acopio
                      $limit  
                      ";
      ...
      $hojaExcel.="<TR><TH colspan='9'><center>CENTROS DE ACOPIO</center></TH></TR>";       
    ...
    if($opcion_vista == 1){
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            $hojaExcel.="<TR>";
            $hojaExcel.="<TD style=background:$color>" . $row2['cod_centro_acopio'] . "</TD>";
            $hojaExcel.="<TD style=background:$color>" . $row2['nombre'] . "</TD>";
            $hojaExcel.="<TD style=background:$color>" . $row2['grupo'] . "</TD>";
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_centro_acopio],2) title='Editar Centro de Acopio'><img src='../imagenes/editar.png' width='14' height='14' border='0' alt='Editar'></a> </center></TD>"; 
            } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
         echo $hojaExcel;
          ...
          $sfile="../excel/CentroAcopio"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
