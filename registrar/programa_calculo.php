...
<html>
<head>
<title>PROGRAMAR CICLO A CALCULAR</title>
<?php
...
<br>
<body>
<form NAME='datechooser' action="valida_programa_calculo.php" method="post">
...
<table width="70%" align="Center" border = "0">
  <tr>
    <th colspan=5><div align="center"><strong>PROGRAMACION DE CICLO A CALCULAR</strong></div></th>
  </tr>
    <?php 
  ...
  <tr>
   <?php
    ////BUSCAMOS LOS CICLOS DEL SISTEMA
  ...
  <tr>
    <td style='font-weight:bold; color: white' colspan=5><strong>Seleccione los menus que desea excluir del calculo</strong></td>
  </tr>   
  <tr>
    <td>&nbsp;</td>
  </tr>   
    <?php
      ...
      $instruccion6 = "SELECT cod_menu, nombre
                       FROM menu
                       ORDER BY cod_menu";
  ...
  <tr>
   <?php
    ////BUSCAMOS LAS PROGRAMCIONES DEL SISTEMA
      print ("<TD style='font-weight:bold; color: white' colspan='5'>Seleccione la programaci�n de Inventarios ");
  ...
  <tr>
    <td style='font-weight:bold; color: white' colspan=5><strong>Nombre Menús</strong>&nbsp;&nbsp;
    <input name="nombre_Menu" placeholder="Ciclo 1 Menu 1-5" type="text" required="required"></td>
  </tr>
 ...
 <table width="70%" align="Center" border = "0">  
  <tr>
    <td colspan=5>
    <div align="center" class="Estilo1"><input type="submit" name="Submit" value="Iniciar Calculo" onclick='return confirm("�Esta seguro de la informaci�n proporcionada esta completa?")'/></div>
    </td>
  </tr>
</table>        
</form>
