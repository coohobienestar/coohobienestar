...
<HEAD>
<TITLE>SUBIR DOCUMENTO REGISTRO</TITLE>
...
<!--
   ...
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    function subir_doc_registro(codigo,tipo_operacion,vista,usuario){ 
    var url="../funciones/upload_docs_registro.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion+"&vista="+vista+"&usuario="+usuario;
   ...
   function actualizaPagina (){
      ...
      window.location = 'admin_subir_documento_registro.php?codigo='+codigo+'&nombre='+nombre+'&pagina='+pagina+'&tipo='+tipo;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1,1,<?php print("$cod_usuario");?>)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Crear Documento Registro</a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='#' title='Actualizar'><img src='../imagenes/actualizar.png' border='0' width='32' height='32' border='0' alt='' onClick='window.location.reload(true);'></a></td>
<?php } ?>
...
<?php                        
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_subir_documento_registro.php' METHOD='POST'>"); 
      print ("<TR style='font-weight:bold; color: white'>");

      ////BUSCAMOS LOS TIPOS DE DOCUMENTO
      ...
      $condicion2 = " 0c_documento_registro.obsoleto <> 1 AND ";
      
      if($tipo != ''){                
         $condicion2 = $condicion2. "0c_documento_registro.cod_clasificacion = $tipo AND ";
        } 
      ...
      $hojaExcel.="<TR><TH colspan='16'><center>DOCUMENTOS DE CALIDAD</center></TH></TR>";       
     ...
     //$hojaExcel.="<TH><center>Eliminar</center></TH>";   
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
          ...
          if($opcion_vista == 1){ 
            if($cod_usuario == $row2[cod_usuario]){  
              $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_documento],2,1,$row2[cod_usuario]) title='Editar Documento'><img src='../imagenes/editar.png' width='18' height='18' border='0' alt=''></a> </center></TD>";          
              }else{
          ...
          if($cod_usuario == $row2[cod_usuario]){
             $hojaExcel.="<TD style=background:$color><center> <a href=javascript:subir_doc_registro($row2[cod_documento],3,$row2[cod_usuario]) title='Subir Documento'><img src='../imagenes/imagen.png' width='18' height='18' border='0' alt='Editar'></a> </center></TD>"; 
           ...
           //  $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_documento],4,1,$row2[cod_usuario]) title='Eliminar Documento'><img src='../imagenes/eliminar.png' width='18' height='18' border='0' alt=''></a> </center></TD>";
             }else{
               $hojaExcel.="<TD style=background:$color><center> -- </center></TD>";
             //  $hojaExcel.="<TD style=background:$color><center> -- </center></TD>";
             //  $hojaExcel.="<TD style=background:$color><center> -- </center></TD>";
