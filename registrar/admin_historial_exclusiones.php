...
<html>
<head>
<title>GUARDAR HISTORIAL DE EXCLUSIONES</title>
<?php
...
<br>
<body>
<form NAME='datechooser' action="valida_guardar_historial_exclusiones.php" method="post">
...
<table width="60%" align="Center" border = "0">
  <tr>
    <th colspan=5><div align="center"><strong>GUARDAR HISTORIAL DE EXCLUSIONES</strong></div></th>
  </tr>
    <?php 
      print ("<td style='font-weight:bold; color: white' colspan=5><strong>Seleccione las Fechas para las cuales desea <strong>GUARDAR</strong> el Historial de Exclusiones</strong></td>");
      print ("<tr><td>&nbsp;</td></tr>");
      ...
      print ("<tr><td>&nbsp;</td></tr>"); 
      print ("<td style='font-weight:bold; color: red' colspan=5><strong>Recuerde que si existe un historial de exclusiones con las mismas fechas este se actualizara.</strong></td>");
      print ("<tr><td>&nbsp;</td></tr>");     
    ?>
  </table>   
 <table width="70%" align="Center" border = "0">  
  <tr>
    <td colspan=5>
    <div align="center" class="Estilo1"><input type="submit" name="Submit" value="Guardar Historial" onclick='return confirm("¿Esta seguro de la información proporcionada es correcta?")'/></div>
    </td>
  </tr>
</table>        
</form>
