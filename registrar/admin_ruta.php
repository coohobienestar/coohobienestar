...
<!--
   ...
   function actualizaPagina (){
      ...
      window.location = 'admin_ruta.php?origen='+origen+'&codigo='+codigo+'&nombre='+nombre+'&pagina='+pagina+'&destino='+destino+'&fecha='+fecha+'&fecha2='+fecha2+'&placa='+placa;
   }
// -->
</SCRIPT>
...
<?php                        
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_ruta.php' METHOD='POST'>");
