...
<!--
   ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    ...
    var url="../admin/operacion_periodo.php?codigo="+codigo+"&tipo_operacion="+tipo_operacion;
   ...
   function actualizaPagina (){
      ...
      window.location = 'admin_periodo.php?codigo='+codigo+'&nombre='+nombre+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php if($opcion_vista == 1){?>
 <td width='30%' style='font-weight:bold; color: #f4d359' align="center"><a href=javascript:operar_tabla(0,1)><img src='../imagenes/guardar.png' width='32' height='32' border='0' alt='Nuevo Registro'>&nbsp;&nbsp;Registrar Periodo</a></td>
<?php } ?>
...
<?php                        
      ...
      $instruccion3 = "SELECT count(cod_periodo) AS cuenta FROM periodo";
      ...
      print ("<FORM NAME='datechooser' ACTION='admin_periodo.php' METHOD='POST'>");
      ...
      if($codigo != ''){
         $condicion2 = $condicion2. "periodo.cod_periodo like '%$codigo%' AND ";
        }
      if($nombre != ''){
         $condicion2 = $condicion2. "periodo.nombre like '%$nombre%' AND ";
        } 
      ...
      $instruccion2 ="SELECT periodo.cod_periodo AS cod_periodo, periodo.nombre AS nombre
                      FROM periodo
                      $condicion_final 
                      ORDER BY periodo.cod_periodo
                      $limit  
                      ";
      ...
      $hojaExcel.="<TR><TH colspan='9'><center>PERIODOS</center></TH></TR>";       
    ...
    if($opcion_vista == 1){
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            $hojaExcel.="<TR>";
            $hojaExcel.="<TD style=background:$color>" . $row2['cod_periodo'] . "</TD>";
            $hojaExcel.="<TD style=background:$color>" . $row2['nombre'] . "</TD>";
          if($opcion_vista == 1){   
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:operar_tabla($row2[cod_periodo],2) title='Editar Periodo'><img src='../imagenes/editar.png' width='14' height='14' border='0' alt='Editar'></a> </center></TD>"; 
            } 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";
         echo $hojaExcel;
          ...
          $sfile="../excel/Periodo"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
