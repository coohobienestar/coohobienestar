...
<html>
<head>
<title>GUARDAR HISTORIAL DE CUPOS</title>
<?php
...
<br>
<body>
<form NAME='datechooser' action="valida_guardar_historial.php" method="post">
...
<table width="60%" align="Center" border = "0">
  <tr>
    <th colspan=5><div align="center"><strong>GUARDAR HISTORIAL DE CUPOS</strong></div></th>
  </tr>
    <?php 
      print ("<td style='font-weight:bold; color: white' colspan=5><strong>Seleccione las Fechas para las cuales desea <strong>GUARDAR</strong> el Historial de Cupos</strong></td>");
      print ("<tr><td>&nbsp;</td></tr>");
