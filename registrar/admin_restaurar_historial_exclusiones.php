...
<html>
<head>
<title>RESTAURAR HISTORIAL DE EXCLUSIONES</title>
<?php
...
<br>
<body>
<form NAME='datechooser' action="valida_restaurar_historial_exc.php" method="post">
...
<table width="60%" align="Center" border = "0">
  <tr>
    <th colspan=5><div align="center"><strong>RESTAURAR HISTORIAL DE EXCLUSIONES</strong></div></th>
  </tr>
    <?php 
      print ("<td style='font-weight:bold; color: red' colspan=5><strong>RECUERDE QUE DEBE GUARDAR PRIMERO LAS EXCLUSIONES QUE ESTA UTILIZANDO ANTES DE RESTAURAR UN HISTORIAL DE EXCLUSIONES O LOS DATOS ACTUALES SE PERDERAN</strong></td>");
      print ("<tr><td>&nbsp;</td></tr>"); 
      print ("<td style='font-weight:bold; color: white' colspan=5><strong>Seleccione las Fechas para las cuales desea <strong>RESTAURAR</strong> el Historial de Exclusiones</strong></td>");
      print ("<tr><td>&nbsp;</td></tr>");
 ...
 <table width="70%" align="Center" border = "0">  
  <tr>
    <td colspan=5>
    <div align="center" class="Estilo1"><input type="submit" name="Submit" value="Restaurar Historial" onclick='return confirm("¿Esta seguro de la información proporcionada es correcta?")'/></div>
    </td>
  </tr>
</table>        
</form>
