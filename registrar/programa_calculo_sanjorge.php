...
<html>
<head>
<title>PROGRAMAR HOSPITAL SAN JORGE</title>
<?php
...
<br>
<body>
<form NAME='datechooser' action="valida_programa_calculo_sanjorge.php" method="post">
...
<table width="70%" align="Center" border = "0">
  <tr>
    <th colspan=5><div align="center"><strong>PROGRAMACION DE CICLO A CALCULAR PARA HOSPITAL SAN JORGE</strong></div></th>
  </tr>
    <?php 
  ...
  <tr>
   <?php
    ////BUSCAMOS LOS CICLOS DEL SISTEMA LOS USADOS PARA PROGRAMAR NO EL CICLO MATRIZ
      ...
      $instruccion = "SELECT cod_ciclo, nombre FROM ciclo WHERE cod_ciclo BETWEEN 946 AND 949 ORDER BY cod_ciclo";
      $consulta = mysql_query ($instruccion, $conexion);
  ...
  <tr>
    ...
    <?php
      ...
      $instruccion6 = "SELECT DISTINCT menu.cod_menu AS cod_menu, menu.nombre AS nombre
                       ...
                       WHERE plato_ingrediente.cod_minuta BETWEEN 9976 AND 9980
   ...
   <?php
    ////BUSCAMOS LAS PROGRAMCIONES DEL SISTEMA
      ...
      $instruccion = "SELECT DISTINCT programacion.cod_programacion AS cod_programacion, ciclo.nombre AS nombre
                      ...
                      WHERE programacion.estado = 1 AND programacion.cod_ciclo BETWEEN 946 AND 949
