...
<!--
   ...
   function actualizaPagina (){
      ...
      window.location = 'inf_listaentrega_13.php?programacion='+programacion+'&departamento='+departamento+'&nom_municipio='+nom_municipio+'&nom_escuela='+nom_escuela+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      print ("<FORM NAME='datechooser' ACTION='inf_listaentrega_13.php' METHOD='POST'>");
