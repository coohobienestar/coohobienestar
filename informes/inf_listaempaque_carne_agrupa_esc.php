...
<!--
    ...
    function generar_informe(cod_programacion,cod_municipio,tipo_minuta,tipo_informe){ 
    var url="../admin/operacion_listaempaque_carne_agrupa_esc.php?cod_programacion="+cod_programacion+"&cod_municipio="+cod_municipio+"&tipo_minuta="+tipo_minuta+"&tipo_informe="+tipo_informe;
   ...
   function actualizaPagina (){
      ...
      window.location = 'inf_listaempaque_carne_agrupa_esc.php?programacion='+programacion+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
session_start();
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      print ("<FORM NAME='datechooser' ACTION='inf_listaempaque_carne_agrupa_esc.php' METHOD='POST'>");
      ...
      if($cod_programacion != ''){
         $condicion2 = $condicion2. "calculo_redondeado_escuela.cod_programacion = '$cod_programacion' AND calculo_redondeado_escuela.cod_municipio = 74 AND ";
        }
      ...
      $instruccion2 ="SELECT DISTINCT calculo_redondeado_escuela.cod_municipio AS cod_municipio, municipio.nombre AS nom_municipio,
                      ...
                      $condicion_final  
                      ORDER BY calculo_redondeado_escuela.cod_tipo_minuta, calculo_redondeado_escuela.cod_municipio                      
                      ";
      ...
      if ($nfilas > 0){
        ...
        $hojaExcel.="<TR><TH colspan='6'><center>LISTAS DE EMPAQUE CARNE -- [Programación: $cod_programacion]</center></TH></TR>";       
        $hojaExcel.="<TH><center>Municipio</center></TH>";
        $hojaExcel.="<TH><center>Ver Informe Municipio &nbsp;&nbsp;<a href=javascript:generar_informe($cod_programacion,0,0,1) title='Ver Todos'><img src='../imagenes/informe.png' width='24' height='24' border='0' alt='Generar Informe'></a></center></TH>";
        $hojaExcel.="</TR>";
        ...
        $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            if($cod_tipo_minuta != $ant_cod_tipo_minuta){
               ...
               $hojaExcel.=" <a href=javascript:generar_informe($cod_programacion,$row2[cod_municipio],$cod_tipo_minuta,1) title='Ver Informe $row2[nom_municipio]'><img src='../imagenes/informe.png' width='22' height='22' border='0' alt='Generar Informe'></a> </center></TH>";
               $hojaExcel.="</TR>";
              }
            ...
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:generar_informe($cod_programacion,$row2[cod_municipio],0,1) title='Ver Informe $row2[nom_municipio]'><img src='../imagenes/informe.png' width='18' height='18' border='0' alt='Generar Informe'></a> </center></TD>"; 
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";    
         echo $hojaExcel;
          ...
          $fecha = date("Ymd_His");
          $sfile="../excel/inf_listasempaqueCarneAGREsc"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
