...
<HTML LANG="es">  
<HEAD>
<TITLE>LISTA DE ENTREGA POR CENTRO DE ACOPIO PAE 2015</TITLE>
<link rel="stylesheet" type="text/css" href="../estilos/estilo.css">
<SCRIPT SRC="../calendar/calendar.js"></SCRIPT>
<SCRIPT LANGUAGE='JavaScript'>
<!--
    ////FUNCION PARA HACER OPERACIONES SOBRE LAS TABLAS [REGISTRAR (1) - EDITAR (2)]
    function generar_informe(cod_programacion,cod_centro_acopio,cod_escuela,cod_modalidad,tipo){ 
    var url="../admin/operacion_lista_entrega_centro_acopio_15.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_centro_acopio="+cod_centro_acopio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    open(url,"_blank","Sizewindow,width=1200,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }

    function generar_informe_es(cod_programacion,cod_centro_acopio,cod_escuela,cod_modalidad,tipo){ 
    var url="../admin/operacion_control_es_cc.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_centro_acopio="+cod_centro_acopio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    open(url,"_blank","Sizewindow,width=1200,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }
    
    function generar_informe_es_martes(cod_programacion,cod_centro_acopio,cod_escuela,cod_modalidad,tipo){ 
    var url="../admin/operacion_control_es_cc_martes.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_centro_acopio="+cod_centro_acopio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    open(url,"_blank","Sizewindow,width=1200,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }
    
    function generar_informe_es_miercoles(cod_programacion,cod_centro_acopio,cod_escuela,cod_modalidad,tipo){ 
    var url="../admin/operacion_control_es_cc_miercoles.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_centro_acopio="+cod_centro_acopio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    open(url,"_blank","Sizewindow,width=1200,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    } 
    
    function generar_informe_es_viernes(cod_programacion,cod_centro_acopio,cod_escuela,cod_modalidad,tipo){ 
    var url="../admin/operacion_control_es_cc_viernes.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_centro_acopio="+cod_centro_acopio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    open(url,"_blank","Sizewindow,width=1200,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }           
   ...
   function actualizaPagina (){
      ...
      nom_centro_acopio = document.forms.datechooser.nom_centro_acopio.value;
      ...
      window.location = 'inf_listaentrega_centro_acopio_15.php?programacion='+programacion+'&departamento='+departamento+'&nom_centro_acopio='+nom_centro_acopio+'&nom_escuela='+nom_escuela+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      $nom_centro_acopio = $_REQUEST['nom_centro_acopio'];
      ...
      print ("<FORM NAME='datechooser' ACTION='inf_listaentrega_centro_acopio_15.php' METHOD='POST'>");
      ...
      print ("<TD>Municipio ");
      print ("<INPUT type='text' name='nom_centro_acopio' value=''></TD>");         
      ...
      if($nom_centro_acopio != ''){
         $condicion2 = $condicion2. "centro_acopio.nombre like '%$nom_centro_acopio%' AND ";
        } 
      if($nom_escuela != ''){
      ...
      $instruccion2 ="SELECT DISTINCT calculo_requerimientos.cod_escuela AS cod_escuela, escuela.nombre AS nom_escuela, 
                                      ...
                                      calculo_requerimientos.cod_centro_acopio AS cod_centro_acopio, centro_acopio.nombre AS nom_centro_acopio, 
                      ...
                      ORDER BY minuta.cod_tipo_minuta, calculo_requerimientos.cod_departamento, calculo_requerimientos.cod_centro_acopio,  
                               calculo_requerimientos.cod_municipio, calculo_requerimientos.cod_escuela                     
                      ";
    ...
    if ($cod_programacion != ''){         
      if ($nfilas > 0){
        ...
        $hojaExcel="<TABLE width='90%'>";
        $hojaExcel.="<TR><TH colspan='10'><center>LISTAS DE ENTREGA -- [Programación: $cod_programacion] </center></TH></TR>";       
        $hojaExcel.="<TH><center>Departamento</center></TH>";
        $hojaExcel.="<TH>Centro Acopio</TH>";
      ...
      //$hojaExcel.="<TH><center>Control E/S </center></TH>";
        ...
        $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            if($escoordinador != 1){
              if($cod_tipo_minuta != $ant_cod_tipo_minuta){
                 $hojaExcel.="<TR>";
                 $hojaExcel.="<TH colspan='10'><center>" . $row2[nom_tipo_minuta] ."</center></TH>"; 
           ...
           if($row2[cod_centro_acopio] != $cod_centro_acopio_ant){
             $hojaExcel.="<TD style=background:$color>" . $row2['nom_centro_acopio'] ."</TD>"; 
             $hojaExcel.="<TD style=background:$color> <center><a href=javascript:generar_informe($cod_programacion,$row2[cod_centro_acopio],0,$row2[cod_modalidad],$cod_tipo_minuta) title = 'Imprimir Lista Entrega Municipio $row2[nom_centro_acopio]'><img src='../imagenes/informe.png' width='18' height='18' border='0' alt='Generar Informe'></a></center> </TD>";            
             $hojaExcel.="<TD style=background:$color> <center><a href=javascript:generar_informe_es($cod_programacion,$row2[cod_centro_acopio],0,$row2[cod_modalidad],$cod_tipo_minuta) title = 'Imprimir Control E/S Municipio $row2[nom_centro_acopio]'><img src='../imagenes/informe_02.png' width='18' height='18' border='0' alt='Lunes-Viernes'></a></center> </TD>";
             $hojaExcel.="<TD style=background:$color> <center><a href=javascript:generar_informe_es_martes($cod_programacion,$row2[cod_centro_acopio],0,$row2[cod_modalidad],$cod_tipo_minuta) title = 'Imprimir Control E/S Municipio $row2[nom_centro_acopio]'><img src='../imagenes/informe_02.png' width='18' height='18' border='0' alt='Martes-Martes'></a></center> </TD>";
             $hojaExcel.="<TD style=background:$color> <center><a href=javascript:generar_informe_es_miercoles($cod_programacion,$row2[cod_centro_acopio],0,$row2[cod_modalidad],$cod_tipo_minuta) title = 'Imprimir Control E/S Municipio $row2[nom_centro_acopio]'><img src='../imagenes/informe_02.png' width='18' height='18' border='0' alt='Miercoles-Miercoles'></a></center> </TD>";
             $hojaExcel.="<TD style=background:$color> <center><a href=javascript:generar_informe_es_viernes($cod_programacion,$row2[cod_centro_acopio],0,$row2[cod_modalidad],$cod_tipo_minuta) title = 'Imprimir Control E/S Municipio $row2[nom_centro_acopio]'><img src='../imagenes/informe_02.png' width='18' height='18' border='0' alt='Viernes-Jueves'></a></center> </TD>";
            }else{
              $hojaExcel.="<TD style=background:$color>" . $row2['nom_centro_acopio'] . "</TD>";
            ...
            $cod_centro_acopio_ant = $row2[cod_centro_acopio];
         ...
         echo $hojaExcel;
          ...
          $fecha = date("Ymd_His");
          $sfile="../excel/Lista_entrega_centro_acopio"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
