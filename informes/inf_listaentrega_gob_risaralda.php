...
<HTML LANG="es">  
<HEAD>
<TITLE>LISTA DE ENTREGA GOBERNACION RISARALDA</TITLE>
...
<!--
    ...
    var url="../admin/operacion_listaentrega_gob_risaralda.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_municipio="+cod_municipio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    ...
    var url="../admin/operacion_control_es_gob_risaralda.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_municipio="+cod_municipio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    open(url,"_blank","Sizewindow,width=1200,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }
   ...
   function actualizaPagina (){
      ...
      window.location = 'inf_listaentrega_gob_risaralda.php?programacion='+programacion+'&departamento='+departamento+'&nom_municipio='+nom_municipio+'&nom_escuela='+nom_escuela+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      print ("<FORM NAME='datechooser' ACTION='inf_listaentrega_gob_risaralda.php' METHOD='POST'>");
