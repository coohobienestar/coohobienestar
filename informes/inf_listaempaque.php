...
<!--
    ...
    var url="../admin/operacion_listaempaque.php?cod_programacion="+cod_programacion+"&cod_departamento="+cod_departamento+"&tipo_informe="+tipo_informe+"&quitar_carne="+quitar_carne+"&unificar_cat="+unificar_cat+"&centro_acopio="+centro_acopio;
   ...
   function actualizaPagina (){
      ...
      window.location = 'inf_listaempaque.php?programacion='+programacion+'&quitar_carne='+quitar_carne+'&pagina='+pagina+'&unificar_cat='+unificar_cat;
   }
// -->
</SCRIPT>
...
session_start();
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      print ("<FORM NAME='datechooser' ACTION='inf_listaempaque.php' METHOD='POST'>");
      ...
      if ($nfilas > 0){
        ...
        $hojaExcel.="<TR><TH colspan='6'><center>LISTAS DE EMPAQUE -- [Programaci�n: $cod_programacion]</center></TH></TR>";       
        ...
        $hojaExcel.="<TH><center>Totales</center></TH>";
        $hojaExcel.="</TR>";
...
////**************************************generamos una tabla con los centros de acopio
  ////EJECUTAMOS LA CONSULTA
      ...
      $nfilas3 = mysql_num_rows ($consulta3);
        ...
        $hojaExcel.="<TR><TH colspan='6'><center>LISTAS DE EMPAQUE POR CENTRO DE ACOPIO-- [Programaci�n: $cod_programacion]</center></TH></TR>";       
        ...
        $color = '';
         ...
         echo $hojaExcel;
          ...
          $fecha = date("Ymd_His");
          $sfile="../excel/inf_listasempaque"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
