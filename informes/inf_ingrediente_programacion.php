...
<HTML LANG="es">  
<HEAD>
<TITLE>CONSUMO DE INGREDIENTE POR PROGRAMACION Y PROGRAMA DETALLADO</TITLE>
...
<!-- 
   ...
   function actualizaPagina (){
      ...
      window.location = 'inf_ingrediente_programacion.php?ingrediente='+ingrediente+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
session_start();
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      print ("<FORM NAME='datechooser' ACTION='inf_ingrediente_programacion.php' METHOD='POST'>");
      ...
      $instruccion2 ="SELECT DISTINCT calculo_redondeado_escuela.cod_programacion AS cod_programacion, calculo_redondeado_escuela.cod_ingrediente AS cod_ingrediente, 
                             ...
                             calculo_redondeado_escuela.cantidad_redondeada AS cantidad_redondeada, calculo_redondeado_escuela.cod_unidad_medida AS cod_unidad_medida, 
                             ...
                             ingrediente_unidad_entrega_consulta.codigo_geminus AS codigo_geminus, calculo_redondeado_escuela.cod_escuela, escuela.nombre AS nom_escuela   
      ...
      if ($nfilas > 0){
        ...
        $hojaExcel.="<TR><TH colspan='13'><center>INGREDIENTE POR PROGRAMACION Y PROGRAMA DETALLADO -- [Ingrediente: $ingrediente]</center></TH></TR>";       
        ...
        $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            $hojaExcel.="<TD style=background:$color>" . $row2['cantidad_redondeada'] . "</TD>";
