...
session_start();
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      print ("<FORM NAME='datechooser' ACTION='inf_acta_despacho.php' METHOD='POST'>");
      print ("<TR style='font-weight:bold; color: white'>");
      
      ////BUSCAMOS LAS PROGRAMACIONES
      print ("<TD>Programaci�n 1 ");
      ...
      ////BUSCAMOS LAS PROGRAMACIONES
      print ("<TR  style='font-weight:bold; color: white'><TD>Programaci�n 3");
      ...
      ////BUSCAMOS LAS PROGRAMACIONES
      print ("<TR style='font-weight:bold; color: white'><TD>Programaci�n 5");
      ...
      print ("<TR style='font-weight:bold; color: white'><TD>Programaci�n 7");
...
////BUSCAMOS LAS PROGRAMACIONES   9
      print ("<TR style='font-weight:bold; color: white'><TD>Programaci�n 9");
...
////BUSCAMOS LAS PROGRAMACIONES   11
      print ("<TR style='font-weight:bold; color: white'><TD>Programaci�n 11");
...
////BUSCAMOS LAS PROGRAMACIONES   12
      ...
      print ("<TR style='font-weight:bold; color: white'><TD>Programaci�n 13");
 ...
 ////BUSCAMOS LAS PROGRAMACIONES   15
      print ("<TR style='font-weight:bold; color: white'><TD>Programaci�n 15");
 ...
 ////BUSCAMOS LAS PROGRAMACIONES   17
      print ("<TR style='font-weight:bold; color: white'><TD>Programaci�n 17");
 ...
 ////BUSCAMOS LAS PROGRAMACIONES   19
      print ("<TR style='font-weight:bold; color: white'><TD>Programaci�n 19");
 ...
 ////BUSCAMOS LAS PROGRAMACIONES   21
      print ("<TR style='font-weight:bold; color: white'><TD>Programaci�n 21");
...
////BUSCAMOS LAS PROGRAMACIONES   23
      print ("<TR style='font-weight:bold; color: white'><TD>Programaci�n 23");
     ...
     ////BUSCAMOS LAS PROGRAMACIONES   24
      ...
      print ("<INPUT type='text' name='periodo_entrega' size='60' value=''></TD></TR>");           
  ...
  //    if($cod_programacion != '' && $cod_programacion2 != '' && $cod_programacion3 != '' && $cod_programacion4 != '' && $cod_programacion5 != '' && $cod_programacion6 != '' && $cod_programacion7 != '' && $cod_programacion8 != '' && $cod_programacion9 != '' && $cod_programacion10 != '' && $cod_programacion11 != '' && $cod_programacion12 != '' && $cod_programacion13 != '' && $cod_programacion14 != ''){
       ...
       if($categoria != '0'){ 
        ...
        $color = '';
            ...
            if($row2[cod_centro_acopio] != $ca_ant){
             ...
             $ca_ant = $row2[cod_centro_acopio];
               ...
               if($row2[cod_centro_acopio] != $caco_ant){
                  $hojaExcel.="<TD style=background:$color><center> <a href=javascript:generar_informe_ad($cod_programacion,$cod_programacion2,$cod_programacion3,$row2[cod_centro_acopio],0,$row2[cod_departamento],$cod_tipo_minuta,$cod_programacion4,$cod_programacion5,$cod_programacion6,$cod_programacion7,$cod_programacion8,$cod_programacion9,$cod_programacion10,$cod_programacion11,$cod_programacion12,$cod_programacion13,$cod_programacion14,$tipo_informe,$categoria,'$periodo_entrega',$cod_programacion15,$cod_programacion16,$cod_programacion17,$cod_programacion18,$cod_programacion19,$cod_programacion20,$cod_programacion21,$cod_programacion22,$cod_programacion23,$cod_programacion24)><img src='../imagenes/informe_02.png' width='18' height='18' border='0' alt=''></a></center></TD>";            
         ...
         echo $hojaExcel;
          ...
          $fecha = date("Ymd_His");
          $sfile="../excel/actas_despacho"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
