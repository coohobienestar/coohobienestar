...
<?php                        
      ...
      $instruccion2 ="SELECT 0c_documento_calidad.cod_documento AS cod_documento, 0c_documento_calidad.cod_usuario AS cod_usuario, 
                      ...
                      INNER JOIN 0c_usuario_documento ON 0c_usuario_documento.cod_documento = 0c_documento_calidad.cod_documento
                      WHERE 0c_documento_calidad.obsoleto <> 1 AND  0c_usuario_documento.cod_usuario = $cod_usuario
