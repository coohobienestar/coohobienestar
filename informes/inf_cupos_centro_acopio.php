...
<HTML LANG="es">  
<HEAD>
<TITLE>INFORME DE CUPOS POR CENTRO DE ACOPIO</TITLE>
...
session_start();
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      print ("<FORM NAME='datechooser' ACTION='inf_cupos_centro_acopio.php' METHOD='POST'>");
      ...
      $instruccion2 ="SELECT escuela.cod_escuela AS cod_escuela, escuela.nombre AS nom_escuela, centro_acopio.nombre AS nom_centro_acopio, 
                      ...
                      ORDER BY tipo_minuta.cod_tipo_minuta, centro_acopio.nombre, escuela.nombre                  
                      ";
      ...
      if ($nfilas > 0){
        ...
        $hojaExcel.="<TR><TH colspan='12'><center>INFORME DE CUPOS POR CENTRO DE ACOPIOS</center></TH></TR>";       
