...
<HTML LANG="es">  
<HEAD>
<TITLE>LISTA DE ENTREGA ESPECIALES</TITLE>
...
<!--
    ...
    var url="../admin/operacion_listaentrega_13.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_municipio="+cod_municipio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    ...
    var url="../admin/operacion_control_es_especial.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_municipio="+cod_municipio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    open(url,"_blank","Sizewindow,width=1200,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }

    function generar_informe_es_4_dias(cod_programacion,cod_municipio,cod_escuela,cod_modalidad,tipo){ 
    var url="../admin/operacion_control_es_especial_4dias.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_municipio="+cod_municipio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    open(url,"_blank","Sizewindow,width=1200,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }
   ...
   function actualizaPagina (){
      ...
      window.location = 'inf_listaentrega_especial.php?programacion='+programacion+'&departamento='+departamento+'&nom_municipio='+nom_municipio+'&nom_escuela='+nom_escuela+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      print ("<FORM NAME='datechooser' ACTION='inf_listaentrega_especial.php' METHOD='POST'>");
      print ("<TR style='font-weight:bold; color: white'>");
      
      ////BUSCAMOS LAS PROGRAMACIONES
      print ("<TD>Programaci�n ");
    ...
    if ($cod_programacion != ''){         
      if ($nfilas > 0){
        ...
        $hojaExcel.="<TR><TH colspan='9'><center>LISTAS DE ENTREGA -- [Programaci�n: $cod_programacion] </center></TH></TR>";       
        ...
        $hojaExcel.="<TH><center>Control E/S 5 dias</center></TH>";
        $hojaExcel.="<TH><center>Control E/S 4 dias</center></TH>";
        $hojaExcel.="</TR>";
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            if($escoordinador != 1){
              if($cod_tipo_minuta != $ant_cod_tipo_minuta){
                 ...
                 $hojaExcel.="<TH><center><a href=javascript:generar_informe_es_4_dias($cod_programacion,0,0,0,$cod_tipo_minuta) title='Imprimir Todos $row2[nom_tipo_minuta]'><img src='../imagenes/informe_02.png' width='24' height='24' border='0' alt='Generar Informe'></a></center></TH>";
                 $hojaExcel.="</TR>";
                }
           ...
           if($row2[cod_municipio] != $cod_municipio_ant){
            ...
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:generar_informe_es_4_dias($cod_programacion,0,$cod_escuela,$row2[cod_modalidad],$cod_tipo_minuta)><img src='../imagenes/informe_02.png' width='18' height='18' border='0' alt='Generar Informe'></a> </center></TD>";
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";    
         echo $hojaExcel;
          ...
          $fecha = date("Ymd_His");
          $sfile="../excel/Lista_entrega_especial"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
