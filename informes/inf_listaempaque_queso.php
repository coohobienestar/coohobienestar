...
<HTML LANG="es">  
<HEAD>
<TITLE>LISTA DE EMPAQUE QUESO</TITLE>
...
<!--
    ...
    var url="../admin/operacion_listaempaque_queso.php?cod_programacion="+cod_programacion+"&cod_municipio="+cod_municipio+"&tipo_minuta="+tipo_minuta+"&tipo_informe="+tipo_informe;
   ...
   function actualizaPagina (){
      ...
      window.location = 'inf_listaempaque_queso.php?programacion='+programacion+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
session_start();
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      print ("<FORM NAME='datechooser' ACTION='inf_listaempaque_queso.php' METHOD='POST'>");
      ...
      if ($nfilas > 0){
        ...
        $hojaExcel.="<TR><TH colspan='6'><center>LISTAS DE EMPAQUE QUESO -- [Programación: $cod_programacion]</center></TH></TR>";       
        ...
        $color = '';
         ...
         echo $hojaExcel;
          ...
          $fecha = date("Ymd_His");
          $sfile="../excel/inf_listasempaqueQueso"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
