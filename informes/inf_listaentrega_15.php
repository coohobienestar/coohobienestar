...
<HTML LANG="es">  
<HEAD>
<TITLE>LISTA DE ENTREGA PAE 2015</TITLE>
...
<!--
    ...
    var url="../admin/operacion_listaentrega_15.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_municipio="+cod_municipio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    ...
    var url="../admin/operacion_control_es_martes.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_municipio="+cod_municipio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    open(url,"_blank","Sizewindow,width=1200,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }  
 
    function generar_informe_es_miercoles(cod_programacion,cod_municipio,cod_escuela,cod_modalidad,tipo){ 
    var url="../admin/operacion_control_es_miercoles.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_municipio="+cod_municipio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    open(url,"_blank","Sizewindow,width=1200,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }   

    function generar_informe_es_viernes(cod_programacion,cod_municipio,cod_escuela,cod_modalidad,tipo){ 
    var url="../admin/operacion_control_es_viernes.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_municipio="+cod_municipio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    open(url,"_blank","Sizewindow,width=1200,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }
    
    function generar_informe_es_martes_lunes(cod_programacion,cod_municipio,cod_escuela,cod_modalidad,tipo){ 
    var url="../admin/operacion_control_es_martes_lunes.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_municipio="+cod_municipio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
    open(url,"_blank","Sizewindow,width=1200,height=700,top=50,left=50,scrollbars=yes,toolbar=no,directories=no,location=no") 
    }         
   ...
   function actualizaPagina (){
      ...
      window.location = 'inf_listaentrega_15.php?programacion='+programacion+'&departamento='+departamento+'&nom_municipio='+nom_municipio+'&nom_escuela='+nom_escuela+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      print ("<FORM NAME='datechooser' ACTION='inf_listaentrega_15.php' METHOD='POST'>");
      ...
      if($nfilas_usu > 0){
         $condicion_usu = " AND (";
         $escoordinador = 1; 
          for ($u=0; $u<$nfilas_usu; $u++){
           $row_usu = mysql_fetch_array ($consulta_usu);
           
           $cod_municipio = $row_usu['cod_municipio'];
           
           $condicion_usu2 = $condicion_usu2." calculo_requerimientos.cod_municipio = $cod_municipio OR";          
          } 
          
          $condicion_usu2 = substr($condicion_usu2, 0, -3); 
          $condicion_usu_final = $condicion_usu.$condicion_usu2.")";          
       }    
    ...
    if ($cod_programacion != ''){         
      if ($nfilas > 0){
        ...
        $hojaExcel.="<TR><TH colspan='16'><center>LISTAS DE ENTREGA -- [Programación: $cod_programacion] </center></TH></TR>";       
        $hojaExcel.="<TH><center>Departamento</center></TH>";
        $hojaExcel.="<TH colspan='7'><center>Municipio</center></TH>";
        $hojaExcel.="<TH><center>Escuela</center></TH>";
        $hojaExcel.="<TH><center>Modalidad</center></TH>";
        $hojaExcel.="<TH><center>Lista Entrega </center></TH>";
        $hojaExcel.="<TH colspan='5'><center>Control E/S </center></TH>";
        $hojaExcel.="</TR>";
        $hojaExcel.="<TR>";
        $hojaExcel.="<TH colspan='11'><center>&nbsp;</center></TH>";       
        ...
        $hojaExcel.="<TH><center>Martes-Lunes</center></TH>";
        $hojaExcel.="</TR>";
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            if($escoordinador != 1){
              if($cod_tipo_minuta != $ant_cod_tipo_minuta){
                 ...
                 $hojaExcel.="<TH><center><a href=javascript:generar_informe_es_martes_lunes($cod_programacion,0,0,0,$cod_tipo_minuta) title='Imprimir Todos $row2[nom_tipo_minuta]'><img src='../imagenes/informe_02.png' width='24' height='24' border='0' alt='Generar Informe'></a></center></TH>";
                 $hojaExcel.="</TR>";
                }
           ...
           if($row2[cod_municipio] != $cod_municipio_ant){
             ...
             $hojaExcel.="<TD style=background:$color><center> <a href=javascript:generar_informe_es_martes_lunes($cod_programacion,$row2[cod_municipio],0,$row2[cod_modalidad],$cod_tipo_minuta) title = 'Imprimir Control E/S Municipio $row2[nom_municipio]'><img src='../imagenes/informe_02.png' width='18' height='18' border='0' alt='Generar Informe'></a> </center></TD>";
            }else{
              $hojaExcel.="<TD style=background:$color>" . $row2['nom_municipio'] . "</TD>";
            ...
            $hojaExcel.="<TD style=background:$color><center> <a href=javascript:generar_informe_es_martes_lunes($cod_programacion,0,$cod_escuela,$row2[cod_modalidad],$cod_tipo_minuta)><img src='../imagenes/informe_02.png' width='18' height='18' border='0' alt='Generar Informe'></a> </center></TD>";
            $hojaExcel.="</TR>";
         }
         $hojaExcel.="</TABLE>";    
         echo $hojaExcel;
