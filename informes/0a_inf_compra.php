...
<!--
   ...
   function actualizaPagina (){
      ...
      o = document.forms.datechooser.ordenar.selectedIndex;
      ordenar = document.forms.datechooser.ordenar.options[o].value; 
      ...
      window.location = '0a_admin_compra.php?producto='+producto+'&codigo='+codigo+'&nombre='+nombre+'&presentacion='+presentacion+'&pagina='+pagina+'&proveedor='+proveedor+'&ordenar='+ordenar+'&factura='+factura;
   }
// -->
</SCRIPT>
...
session_start();
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      print ("<FORM NAME='datechooser' ACTION='0a_inf_compra.php' METHOD='POST'>");
 ...
 /*   print ("<TD>Código <INPUT type='text' size='5' name='codigo' value=''></TD>");
      ...
      $descp_m = "--";
       ...
       print ("<INPUT type='text' size='5' name='factura' value=''></TD>");
        ...
        print("<TD>Ordenar por ");
        print("<select name='ordenar'>");
          print("<option value='0'>--</option>");
          print("<option value='1'>Precio Ascendente</option>");
          print("<option value='2'>Precio Descendente</option>");
          print("<option value='3'>Fecha de Compra Ascendente</option>");
          print("<option value='4'>Fecha de Compra Descendente</option>");
        print("</select></TD>");
      ...
      /////MIRAMOS COMO SE ORDENA LA BUSQUEDA 
      if($ordenar == 1){
          $orden = " ORDER BY 0a_compra.valor_unitario ASC ";
        } 
        
      if($ordenar == 2){
          $orden = " ORDER BY 0a_compra.valor_unitario DESC ";
        }  
        
      if($ordenar == 3){
          $orden = " ORDER BY 0a_compra.fecha ASC ";
        }  
        
      if($ordenar == 4){
          $orden = " ORDER BY 0a_compra.fecha DESC ";
        }   
      
      if($ordenar == 0){
          $orden = " ORDER BY 0a_compra.cod_compra DESC ";
        }                            
      ...
      $instruccion2 ="SELECT 0a_compra.cod_compra AS cod_compra, 0a_compra.cod_producto AS cod_producto, 0a_producto.nombre AS nom_producto, 
                             ...
                             0a_producto.iva AS iva, 0a_proveedor.nit AS nit 
                      FROM 0a_compra 
      ...
      $hojaExcel.="<TH><center>IVA</center></TH>";
      $hojaExcel.="<TH><center>Presentación</center></TH>";
      $hojaExcel.="<TH colspan='2'><center>Proveedor</center></TH>";
    ...
    if($opcion_vista == 1){  
      ...
      $color = '';
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            $hojaExcel.="<TD style=background:$color>" . $row2['iva'] . "</TD>";
        ...
        //  $hojaExcel.="<TD style=background:$color>" . $row2['cantidad'] . "</TD>";
         ...
         echo $hojaExcel;
          ...
          $sfile="../excel/inf_Compras"._."$login"._."$fecha.xls"; //ruta del archivo a generar 
          $fp=fopen($sfile,"w"); 
          fwrite($fp,$hojaExcel); 
          fclose($fp);
