...
<!--
    ...
    var url="../admin/operacion_lista_entrega_centro_acopio.php?cod_programacion="+cod_programacion+"&cod_modalidad="+cod_modalidad+"&cod_centro_acopio="+cod_centro_acopio+"&cod_escuela="+cod_escuela+"&tipo="+tipo;
   ...
   function actualizaPagina (){
      ...
      window.location = 'inf_listaentrega_centro_acopio.php?programacion='+programacion+'&departamento='+departamento+'&nom_centro_acopio='+nom_centro_acopio+'&nom_escuela='+nom_escuela+'&pagina='+pagina;
   }
// -->
</SCRIPT>
...
<?php
  ...
  error_consulta($result,$registro);                           
    ...
    if(($cod_usuario != '') && ($autorizado==1)){
      ...
      print ("<FORM NAME='datechooser' ACTION='inf_listaentrega_centro_acopio.php' METHOD='POST'>");
    ...
    if ($cod_programacion != ''){         
      if ($nfilas > 0){
        ...
        $hojaExcel.="<TH colspan='3'><center>Centro Acopio</center></TH>";
         ...
         for ($i=0; $i<$nfilas; $i++){
            ...
            if($escoordinador != 1){
              if($cod_tipo_minuta != $ant_cod_tipo_minuta){
                 $hojaExcel.="<TR>";
                 $hojaExcel.="<TH colspan='7'><center>" . $row2[nom_tipo_minuta] ."</center></TH>"; 
           ...
           if($row2[cod_centro_acopio] != $cod_centro_acopio_ant){
             ...
             $hojaExcel.="<TD style=background:$color> <a href=javascript:generar_informe($cod_programacion,$row2[cod_centro_acopio],0,$row2[cod_modalidad],$cod_tipo_minuta) title = 'Imprimir Lista Entrega Municipio $row2[nom_centro_acopio]'><img src='../imagenes/informe.png' width='18' height='18' border='0' alt='Generar Informe'></a> </TD>";            
             $hojaExcel.="<TD style=background:$color> <a href=javascript:generar_informe_es($cod_programacion,$row2[cod_centro_acopio],0,$row2[cod_modalidad],$cod_tipo_minuta) title = 'Imprimir Control E/S Municipio $row2[nom_centro_acopio]'><img src='../imagenes/informe_02.png' width='18' height='18' border='0' alt='Generar Informe'></a> </TD>";
            }else{
              $hojaExcel.="<TD style=background:$color>" . $row2['nom_centro_acopio'] . "</TD>";
